...
var WFOP_Pro_Component = /*#__PURE__*/function (_React$Component) {
  _inherits(WFOP_Pro_Component, _React$Component);

  var _super = _createSuper(WFOP_Pro_Component);

  function WFOP_Pro_Component() {
    var _this;

    _classCallCheck(this, WFOP_Pro_Component);
  ...
  _createClass(WFOP_Pro_Component, [{
  ...
  return WFOP_Pro_Component;
}(react.Component);

_defineProperty(WFOP_Pro_Component, "style_data", []);

/* harmony default export */ const abs_component = (WFOP_Pro_Component);
;// CONCATENATED MODULE: ./optin-form-popup.js
function optin_form_popup_typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { optin_form_popup_typeof = function _typeof(obj) { return typeof obj; }; } else { optin_form_popup_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return optin_form_popup_typeof(obj); }

function optin_form_popup_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function optin_form_popup_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function optin_form_popup_createClass(Constructor, protoProps, staticProps) { if (protoProps) optin_form_popup_defineProperties(Constructor.prototype, protoProps); if (staticProps) optin_form_popup_defineProperties(Constructor, staticProps); return Constructor; }

function _get(target, property, receiver) { if (typeof Reflect !== "undefined" && Reflect.get) { _get = Reflect.get; } else { _get = function _get(target, property, receiver) { var base = _superPropBase(target, property); if (!base) return; var desc = Object.getOwnPropertyDescriptor(base, property); if (desc.get) { return desc.get.call(receiver); } return desc.value; }; } return _get(target, property, receiver || target); }

function _superPropBase(object, property) { while (!Object.prototype.hasOwnProperty.call(object, property)) { object = optin_form_popup_getPrototypeOf(object); if (object === null) break; } return object; }

function optin_form_popup_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) optin_form_popup_setPrototypeOf(subClass, superClass); }

function optin_form_popup_setPrototypeOf(o, p) { optin_form_popup_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return optin_form_popup_setPrototypeOf(o, p); }

function optin_form_popup_createSuper(Derived) { var hasNativeReflectConstruct = optin_form_popup_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = optin_form_popup_getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = optin_form_popup_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return optin_form_popup_possibleConstructorReturn(this, result); }; }

function optin_form_popup_possibleConstructorReturn(self, call) { if (call && (optin_form_popup_typeof(call) === "object" || typeof call === "function")) { return call; } return optin_form_popup_assertThisInitialized(self); }

function optin_form_popup_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function optin_form_popup_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }

function optin_form_popup_getPrototypeOf(o) { optin_form_popup_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return optin_form_popup_getPrototypeOf(o); }

function optin_form_popup_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }



var WFOP_Optin_Form_Popup = /*#__PURE__*/function (_WFOP_PRO_Component) {
  optin_form_popup_inherits(WFOP_Optin_Form_Popup, _WFOP_PRO_Component);

  var _super = optin_form_popup_createSuper(WFOP_Optin_Form_Popup);

  function WFOP_Optin_Form_Popup() {
    var _this;

    optin_form_popup_classCallCheck(this, WFOP_Optin_Form_Popup);

    _this = _super.call(this);
    _this.ajax = true;
    _this.popup_open = 'no';
    _this.c_slug = 'et_wfop_optin_form_popup';
  ...
  optin_form_popup_createClass(WFOP_Optin_Form_Popup, [{
    key: "componentDidUpdate",
    value: function componentDidUpdate(prevProps, prevState, snapshot) {
      this.props.popup_open = this.popup_open;

      _get(optin_form_popup_getPrototypeOf(WFOP_Optin_Form_Popup.prototype), "componentDidUpdate", this).call(this, prevProps, prevState, snapshot);
    }
  }, {
    key: "button_event",
    value: function button_event() {
      var self = this;
    ...
    value: function render() {
      ...
      return _get(optin_form_popup_getPrototypeOf(WFOP_Optin_Form_Popup.prototype), "render", this).call(this);
    }
  }], [{
    key: "css",
    value: function css(props) {
  ...
  return WFOP_Optin_Form_Popup;
}(abs_component);

optin_form_popup_defineProperty(WFOP_Optin_Form_Popup, "slug", 'et_wfop_optin_form_popup');

/* harmony default export */ const optin_form_popup = (WFOP_Optin_Form_Popup);
...
(function ($) {
  $(window).on('et_builder_api_ready', function (event, API) {
    API.registerModules([optin_form_popup]);
  });
})(jQuery);
})();
