...
if ( ! class_exists( 'WFACP_Template_Oxy' ) ) {
	...
	final class WFACP_Template_Oxy extends WFACP_Oxy_Template {
		...
		public function enqueue_style() {
			...
			if ( is_rtl() ) {
				wp_enqueue_style( 'wfacp-oxy-style-rtl', plugin_dir_url( WFACP_PLUGIN_FILE ) . 'assets/css/wfacp-form-style-rtl.css', '', WFACP_VERSION, false );
			}
		}
