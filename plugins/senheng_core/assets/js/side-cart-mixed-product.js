...
jQuery(document).ready(function ($) {
    ...
    var config = {
        debounceDelay: 100,
        messages: {
            mixed: 'You cannot combine physical and virtual products together. Please adjust your cart to proceed.',
            depositMixed: 'You cannot combine partial payment and physical products together. Please adjust your cart to proceed.',
            depositEsd: 'You cannot combine partial payment and virtual products together. Please adjust your cart to proceed.',
        ...
        selectors: {
            ...
            checkoutBtn: '.wc-forward:not(.checkout), .btn-cart.wc-forward, .button.wc-forward:not(.checkout)',
