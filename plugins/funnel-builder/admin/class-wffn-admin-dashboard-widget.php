	...
	class WFFN_Admin_Dashboard_Widget {
		...
		public function widget_content() {
			...
			if ( wffn_is_wc_active() ) {
				...
				$accounting_handle = ( defined( 'WC_VERSION' ) && version_compare( WC_VERSION, '3.0', '>=' ) ) ? 'wc-accounting' : 'accounting';
				wp_localize_script( $accounting_handle, 'wffn_dashboard_params_accounting', array(
                        ...
                        apiService("funnelkit-app/funnel-analytics/dashboard/overview?overall=", 'GET').then((res) => {
                            ...
                            var data = {
                                ...
                                formatMoney: function (amt) {
                                    ...
                                    if ('yes' === fkwidget.is_wc && window.accounting && window.wffn_dashboard_params_accounting) {
