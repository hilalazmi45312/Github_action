...
if ( ! class_exists( 'WFACP_Template_Divi' ) ) {
	...
	final class WFACP_Template_Divi extends WFACP_Divi_Template {
		...
		public function enqueue_style() {
			...
			if ( is_rtl() ) {
				wp_enqueue_style( 'wfacp-divi-style-rtl', plugin_dir_url( WFACP_PLUGIN_FILE ) . 'assets/css/wfacp-form-style-rtl.css', '', WFACP_VERSION, false );
			}
