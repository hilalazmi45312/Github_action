 ...
 */
if ( ! class_exists( 'WFACPKirki_Modules_PostMessage' ) ) {
	class WFACPKirki_Modules_PostMessage {
		...
		public function postmessage() {
			...
			wp_enqueue_script( 'wfacpkirki_auto_postmessage', trailingslashit( WFACPKirki::$url ) . 'modules/postmessage/postmessage.js', array( 'jquery', 'customize-preview' ), WFACP_VERSION, true );
