...
<div class="empty_template_error">
	<div class="bwf-c-global-error" style="display: flex; align-items: center; justify-content: center; height: 60vh;">
		<div class="bwf-c-global-error-center" style="text-align: center; background-color: rgb(255, 255, 255); width: 500px; padding: 50px;">
			...
			<p><?php esc_html_e( 'It seems there are some technical difficulties. Press F12 to open console. Take Screenshot of the error and send it to support.', 'woofunnels-aero-checkout' ) ?></p>
			<a herf="#" class="button button-primary is-primary"><span class="dashicon dashicons dashicons-image-rotate"></span>&nbsp;<?php esc_html_e( 'Refresh', 'woofunnels-aero-checkout' ) ?></a>
		</div>
	</div>
</div>
<?php } else { ?>
    ...
    <div class="wfacp_template_header">
        ...
        <div class="wfacp_template_header_item wfacp_template_editor_wrap wfacp_ml_auto">
            <div class="wfacp_template_editor">
                <span class="wfacp_editor_field_label"><?php _e( 'Page Builder:', 'woofunnels-aero-checkout' ) ?></span>
                <div class="wfacp_editor_field wfacp_field_select_dropdown">
                    ...
                    <div class="wfacp_field_dropdown wfacp-hide">
                        <div class="wfacp_dropdown_header">
                            <label class="wfacp_dropdown_header_label"><?php _e( 'Select Page Builder', 'woofunnels-aero-checkout' ) ?></label>
                        </div>
							...
							<div class="wfacp_temp_overlay">
								<div class="wfacp_temp_middle_align">
									...
									<div class="wfacp_p wfacp_import_template" v-on:click="triggerImport(template,slug,type,$event)">
										<span class="wfacp_import_text"><?php esc_html_e( 'Start from scratch', 'woofunnels-aero-checkout' ); ?></span>
										<span class="wfacp_importing_text"> <?php esc_html_e( 'Importing...', 'woofunnels-aero-checkout' ) ?></span>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="wfacp_temp_overlay">
								<div class="wfacp_temp_middle_align">
									<div class="wfacp_pro_template" v-if="template.pro && `no` === template.license_exist">
										...
										<a target="_blank" href="<?php echo esc_url( 'https://funnelkit.com/exclusive-offer/' ) ?>" class="wfacp_steps_btn wfacp_steps_btn_danger"><?php _e( 'Get PRO', 'woofunnels-aero-checkout' ) ?></a>
									</div>
									<div class="wfacp_pro_template" v-else>
										<a href="javascript:void(0)" v-on:click="triggerPreview(template,slug,type)" class="wfacp_steps_btn wfacp_steps_btn_success"><?php _e( 'Preview', 'woofunnels-aero-checkout' ) ?></a>
										<a href="javascript:void(0)" class="wfacp_steps_btn wfacp_import_template wfacp_btn_blue" v-on:click="triggerImport(template,slug,type,$event)">
											<span class="wfacp_import_text"><?php _e( 'Import', 'woofunnels-aero-checkout' ) ?></span>
											<span class="wfacp_importing_text"><?php _e( 'Importing...', 'woofunnels-aero-checkout' ) ?></span></a>
									</div>
								</div>
							</div>
						</div>

						<div class="wfacp_template_sec_meta" v-if="( true != template.build_from_scratch || `yes`!=selected_template.build_from_scratch )">
						...
						<div class="wfacp_template_preview_wrap">
							<div class="wfacp_template_preview_header">
								...
								<div class="bwf-t-center">
									<a href="javascript:void(0)" class="button button-primary wfacp_import_preview_template" v-on:click="triggerImport(template,slug,type,$event)">
										<span class="wfacp_import_text"><?php esc_html_e( 'Import This Template', 'woofunnels-aero-checkout' ) ?></span>
										<span class="wfacp_importing_text"><?php esc_html_e( 'Importing...', 'woofunnels-aero-checkout' ) ?></span></a>
								</div>
							...
							<div class="wfacp_template_preview_content">
								...
								<div class="wfacp_template_preview_sidebar">
									<div v-for="(template,slug) in templates" v-on:data-slug="slug" v-if="template.build_from_scratch !==true && `yes` !== template.build_from_scratch && ((`undefined`=== typeof currentStepsFilter && template.no_steps === '1' ) ||(`undefined`!==typeof currentStepsFilter) && ( template.no_steps === currentStepsFilter))">
