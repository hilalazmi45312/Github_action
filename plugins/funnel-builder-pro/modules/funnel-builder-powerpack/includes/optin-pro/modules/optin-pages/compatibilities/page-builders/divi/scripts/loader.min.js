    ...
    [
        ...
        function (module, exports, __webpack_require__) {
            ...
            F.prototype.setState = function (a, b) {
                if ("object" !== _typeof2(a) && "function" !== typeof a && null != a) throw Error(C(85));
            ...
            function O(a) {
                return "object" === _typeof2(a) && null !== a && a.$$typeof === p;
            }
            ...
            function T(a, b, c, e) {
                ...
                if (Array.isArray(a)) for (var k = 0; k < a.length; k++) {
                    ...
                    var f = b + U(d, k);
                    g += T(d, f, c, e);
                } else if (null === a || "object" !== _typeof2(a) ? f = null : (f = B && a[B] || a["@@iterator"], f = "function" === typeof f ? f : null), "function" === typeof f) for (a = f.call(a), k = 0; !(d = a.next()).done;) {
        ...
        function (module, __webpack_exports__, __webpack_require__) {
            ...
            __webpack_require__.r(__webpack_exports__); // EXTERNAL MODULE: /home/deepak/development/localwc/wp-content/plugins/funnel-builder/node_modules/react/index.js


            var react = __webpack_require__(0);

            var react_default = /*#__PURE__*/__webpack_require__.n(react); // CONCATENATED MODULE: ./abs-component.js
            ...
            var abs_component = abs_component_WFOP_Component; // CONCATENATED MODULE: ./optin-form.js

            function optin_form_typeof(obj) {
                "@babel/helpers - typeof";

                if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") {
                    optin_form_typeof = function _typeof(obj) {
                        return typeof obj;
                    };
                } else {
                    optin_form_typeof = function _typeof(obj) {
                ...
                return optin_form_typeof(obj);
            }

            function optin_form_classCallCheck(instance, Constructor) {
                if (!_instanceof(instance, Constructor)) {
                    throw new TypeError("Cannot call a class as a function");
                }
            }

            function optin_form_defineProperties(target, props) {
                for (var i = 0; i < props.length; i++) {
                    var descriptor = props[i];
                    descriptor.enumerable = descriptor.enumerable || false;
                    descriptor.configurable = true;
            ...
            function optin_form_createClass(Constructor, protoProps, staticProps) {
                if (protoProps) optin_form_defineProperties(Constructor.prototype, protoProps);
                if (staticProps) optin_form_defineProperties(Constructor, staticProps);
                return Constructor;
            }
            ...
            function _superPropBase(object, property) {
                while (!Object.prototype.hasOwnProperty.call(object, property)) {
                    object = optin_form_getPrototypeOf(object);
            ...
            function optin_form_inherits(subClass, superClass) {
                if (typeof superClass !== "function" && superClass !== null) {
                    throw new TypeError("Super expression must either be null or a function");
                }
                ...
                if (superClass) optin_form_setPrototypeOf(subClass, superClass);
            }

            function optin_form_setPrototypeOf(o, p) {
                optin_form_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) {
                    o.__proto__ = p;
                    return o;
                };

                return optin_form_setPrototypeOf(o, p);
            }

            function optin_form_createSuper(Derived) {
                var hasNativeReflectConstruct = optin_form_isNativeReflectConstruct();
                return function _createSuperInternal() {
                    var Super = optin_form_getPrototypeOf(Derived),
                        result;

                    if (hasNativeReflectConstruct) {
                        var NewTarget = optin_form_getPrototypeOf(this).constructor;
                        result = Reflect.construct(Super, arguments, NewTarget);
                    } else {
                        result = Super.apply(this, arguments);
                    }

                    return optin_form_possibleConstructorReturn(this, result);
                };
            }

            function optin_form_possibleConstructorReturn(self, call) {
                if (call && (optin_form_typeof(call) === "object" || typeof call === "function")) {
                    return call;
                }

                return optin_form_assertThisInitialized(self);
            }

            function optin_form_assertThisInitialized(self) {
                if (self === void 0) {
                    throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
                }
            ...
            function optin_form_isNativeReflectConstruct() {
                if (typeof Reflect === "undefined" || !Reflect.construct) return false;
                if (Reflect.construct.sham) return false;
                if (typeof Proxy === "function") return true;
            ...
            function optin_form_getPrototypeOf(o) {
                optin_form_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) {
                    return o.__proto__ || Object.getPrototypeOf(o);
                };
                return optin_form_getPrototypeOf(o);
            }

            function optin_form_defineProperty(obj, key, value) {
                if (key in obj) {
                    Object.defineProperty(obj, key, {
                        value: value,
                        enumerable: true,
            ...
            var optin_form = WFOP_Optin_Form; // CONCATENATED MODULE: ./optin-form-popup.js

            function optin_form_popup_typeof(obj) {
                "@babel/helpers - typeof";

                if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") {
                    optin_form_popup_typeof = function _typeof(obj) {
                        return typeof obj;
                    };
                } else {
                    optin_form_popup_typeof = function _typeof(obj) {
                ...
                return optin_form_popup_typeof(obj);
            }

            function optin_form_popup_classCallCheck(instance, Constructor) {
                if (!_instanceof(instance, Constructor)) {
                    throw new TypeError("Cannot call a class as a function");
                }
            }

            function optin_form_popup_defineProperties(target, props) {
                for (var i = 0; i < props.length; i++) {
                    var descriptor = props[i];
                    descriptor.enumerable = descriptor.enumerable || false;
                    descriptor.configurable = true;
            ...
            function optin_form_popup_createClass(Constructor, protoProps, staticProps) {
                if (protoProps) optin_form_popup_defineProperties(Constructor.prototype, protoProps);
                if (staticProps) optin_form_popup_defineProperties(Constructor, staticProps);
                return Constructor;
            }

            function optin_form_popup_get(target, property, receiver) {
                if (typeof Reflect !== "undefined" && Reflect.get) {
                    optin_form_popup_get = Reflect.get;
                } else {
                    optin_form_popup_get = function _get(target, property, receiver) {
                        var base = optin_form_popup_superPropBase(target, property);
                        if (!base) return;
                        var desc = Object.getOwnPropertyDescriptor(base, property);
                ...
                return optin_form_popup_get(target, property, receiver || target);
            }

            function optin_form_popup_superPropBase(object, property) {
                while (!Object.prototype.hasOwnProperty.call(object, property)) {
                    object = optin_form_popup_getPrototypeOf(object);
                    if (object === null) break;
                }
            ...
            function optin_form_popup_inherits(subClass, superClass) {
                if (typeof superClass !== "function" && superClass !== null) {
                    throw new TypeError("Super expression must either be null or a function");
                }
                ...
                if (superClass) optin_form_popup_setPrototypeOf(subClass, superClass);
            }

            function optin_form_popup_setPrototypeOf(o, p) {
                optin_form_popup_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) {
                    o.__proto__ = p;
                    return o;
                };

                return optin_form_popup_setPrototypeOf(o, p);
            }

            function optin_form_popup_createSuper(Derived) {
                var hasNativeReflectConstruct = optin_form_popup_isNativeReflectConstruct();
                return function _createSuperInternal() {
                    var Super = optin_form_popup_getPrototypeOf(Derived),
                        result;

                    if (hasNativeReflectConstruct) {
                        var NewTarget = optin_form_popup_getPrototypeOf(this).constructor;
                        result = Reflect.construct(Super, arguments, NewTarget);
                    } else {
                        result = Super.apply(this, arguments);
                    }

                    return optin_form_popup_possibleConstructorReturn(this, result);
                };
            }

            function optin_form_popup_possibleConstructorReturn(self, call) {
                if (call && (optin_form_popup_typeof(call) === "object" || typeof call === "function")) {
                    return call;
                }

                return optin_form_popup_assertThisInitialized(self);
            }

            function optin_form_popup_assertThisInitialized(self) {
                if (self === void 0) {
                    throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
                }
            ...
            function optin_form_popup_isNativeReflectConstruct() {
                if (typeof Reflect === "undefined" || !Reflect.construct) return false;
                if (Reflect.construct.sham) return false;
                if (typeof Proxy === "function") return true;
            ...
            function optin_form_popup_getPrototypeOf(o) {
                optin_form_popup_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) {
                    return o.__proto__ || Object.getPrototypeOf(o);
                };
                return optin_form_popup_getPrototypeOf(o);
            }

            function optin_form_popup_defineProperty(obj, key, value) {
                if (key in obj) {
                    Object.defineProperty(obj, key, {
                        value: value,
                        enumerable: true,
            ...
            var WFOP_Optin_Form_Popup = /*#__PURE__*/function (_WFOP_Component) {
                optin_form_popup_inherits(WFOP_Optin_Form_Popup, _WFOP_Component);
                ...
                optin_form_popup_createClass(WFOP_Optin_Form_Popup, [{
                    ...
                    value: function componentDidUpdate(prevProps, prevState, snapshot) {
                        ...
                        optin_form_popup_get(optin_form_popup_getPrototypeOf(WFOP_Optin_Form_Popup.prototype), "componentDidUpdate", this).call(this, prevProps, prevState, snapshot);
                    }
                }, {
                    key: "button_event",
                    ...
                    value: function render() {
                        ...
                        jQuery(document).trigger('wffn_reload_phone_field');
                        return optin_form_popup_get(optin_form_popup_getPrototypeOf(WFOP_Optin_Form_Popup.prototype), "render", this).call(this);
                    }
                }], [{
                    key: "css",
                    value: function css(props) {
            ...
            var optin_form_popup = WFOP_Optin_Form_Popup; // CONCATENATED MODULE: ./main.js

            __webpack_require__(1);

            (function ($) {
                $(window).on('et_builder_api_ready', function (event, API) {
                    API.registerModules([optin_form, optin_form_popup]);
                });
            })(jQuery);
            /***/
