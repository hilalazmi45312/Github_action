...
$business_details = '<u style="text-decoration: underline;"><a rel="noreferrer noopener" style="text-decoration-line: none; background-color: rgba(0, 0, 0, 0); color: #236fa1;" href="https://funnelkit.com/" target="_blank">' . esc_html( $business_name ) . '</a></u>';
?>
                                                   ...
                                                   style="margin: 0; mso-line-height-alt: 130%; word-break: break-word; font-size: 14px; font-family: arial,helvetica,sans-serif; line-height: 1.3;">
																						<span
																							...
																							<span
                                                                                                ...
                                                                                                class="has-font-size">
<?php echo sprintf( __( 'This email was sent to from your site %s', 'Funnelkit' ), $business_details); ?>																						</span>
																						</span>
