		...
		public function render( $field, $value = null ) {
            ...
            <table style="width:100%;">
                <tr>
                    ...
                    <td><?php _e( 'Categories', 'funnel-builder-powerpack' ); ?></td>
                </tr>
                <tr>
                    ...
                    <td>
                        <select id="<?php echo $field['id']; ?>" name="<?php echo $field['name']; ?>[categories][]" class="chosen_select <?php echo esc_attr( $field['class'] ); ?>" multiple="multiple" data-placeholder="<?php echo( isset( $field['placeholder'] ) ? $field['placeholder'] : __( 'Search...', 'funnel-builder-powerpack' ) ); ?>">
							<?php
