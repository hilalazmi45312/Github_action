...
<div class="wfob_bump_r_outer_wrap wfob_layout_6" v-if="selected_layout=='layout_6'">
                    ...
                    <div class="wfob_pro_txt_wrap">
                        ...
                        <div class="wfob_bgBox_table">
                            <div class="wfob_bgBox_tablecell wfob_check_container">
                                ...
                                <input type="checkbox" id="<?php echo $product_key; ?>" data-value="" class="wfob_checkbox wfob_bump_product wfob-switch">
                                <label for="<?php echo $product_key; ?>"><span class="sw"></span></label>
                            </div>
                        </div>

                        <div class="wfob_l3_l_desc" v-html="get_product_description('<?php echo $product_key; ?>')"></div>
