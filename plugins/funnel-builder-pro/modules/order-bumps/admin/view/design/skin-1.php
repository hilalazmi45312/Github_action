...
?>
<div class="wfob_bump_r_outer_wrap" v-if="selected_layout=='layout_1' || selected_layout=='layout_2'">
        ...
        <div class="wfob_outer">
            <div class="wfob_Box">
                <div class="wfob_bgBox_table">
                    ...
                    <div class="wfob_bgBox_tablecell wfob_price_container" v-if="model.enable_price==true">
                ...
                <div class="wfob_contentBox wfob_clear">
                    <div class="wfob_pro_img_wrap" v-if="<?php echo 'model.product_' . $product_key . '_featured_image'; ?>" v-bind:style="get_image_width('<?php echo $product_key?>')">
