<?php
if ( ! class_exists( 'WFOB_Layout_9' ) ) {
	class WFOB_Layout_9 extends WFOB_Bump {
		protected static $slug = 'layout_9';
		...
		public static function get_default_models() {
			return array(
				...
				'social_proof_tooltip_heading_bg_color'  => '#736CEC',
				'social_proof_tooltip_heading_font_size' => '14',
				'social_proof_tooltip_heading_color'     => '#ffffff',

				'layout'      => 'layout_9',
				'layout_name' => __( 'Skin 9', 'woofunnels-order-bump' ),
				'class_name'  => 'WFOB_Layout_9',

				'error_color'           => '#E20707',
				'product_title'         => __( 'Add {{product_name}} to my order', 'woofunnels-order-bump' ),
				'product_preview_title' => __( 'Add {{product_name}} to my order', 'woofunnels-order-bump' ),

				'product_small_title'    => __( 'Add {{product_name}} to my order', 'woofunnels-order-bump' ),
				'product_featured_image' => true,
				'product_description'    => __( '', 'woofunnels-order-bump' ),
	...
	WFOB_Bump_Fc::register( 'WFOB_Layout_9' );
}