    ...
    <div v-if="current_offer_id>0">
        <div class="wfocu_welcome_wrap"  v-if="is_multi_product_allow?(true):(numberofproducts()==0)">
            <div class="wfocu_welcome_wrap_in">
                    ...
                    <div class="bwf-zero-state">
                        <div class="bwf-zero-state-wrap">
                            ...
                            <div class="bwf-zero-sec bwf-zero-sec-content bwf-h2 bwf-pb-10">
                                ...
                                <div><?php _e( 'Add product to this offer', 'woofunnels-upstroke-one-click-upsell' ); ?></div>
                            </div>
                            <div class="bwf-zero-sec bwf-zero-sec-content bwf-pb-gap">
                                
                                <div class="bwf-h4-1"><?php esc_html_e( 'Add a product that perfectly complements your customer\'s main purchase', 'woofunnels-upstroke-one-click-upsell' ); ?></div>
                            </div>
                            <div class="bwf-zero-sec bwf-zero-sec-buttons bwf-pb-gap">
                                <button type="button" style="cursor: pointer;" class="wfocu_button_inline wfocu_welc_btn" data-izimodal-open="#modal-add-product" data-iziModal-title="Create New Funnel Step" data-izimodal-transitionin="fadeInUp">
				...
				<div class="wfocu_add_new_product" v-else>
					<button type="button" class="wfocu_button_inline wfocu_welc_btn" style="cursor:pointer" data-izimodal-open="#modal-add-product" data-iziModal-title="Create New Funnel Step" data-izimodal-transitionin="fadeInUp">
						<?php _e( 'Add Product', 'woofunnels-upstroke-one-click-upsell' ); ?>
					</button>
				</div>
            </div>
        ...
        <div class="wfocu_welcome_wrap">
            ...
            <div class="bwf-zero-state">
                <div class="bwf-zero-state-wrap">
                    ...
                    <div class="bwf-zero-sec bwf-zero-sec-content bwf-pb-gap">
                        <div class="bwf-h4-1"><?php esc_html_e( 'Add post purchase offers that increase average order value', 'woofunnels-upstroke-one-click-upsell' ); ?></div>
                    </div>
                    <div class="bwf-zero-sec bwf-zero-sec-buttons bwf-pb-gap">
                      <div class="wfocu_button_inline wfocu_welc_btn" style="cursor:pointer" data-izimodal-open="#modal-add-offer-step">
                            <?php echo __( 'Add Offer', 'woofunnels-upstroke-one-click-upsell' ); ?>
                        </div>
                    </div>
                </div>
            </div>
