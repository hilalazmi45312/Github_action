...
if ( ! class_exists( 'WFOCUKirki_Control_Radio_Buttonset' ) ) {
	/**
	...
	class WFOCUKirki_Control_Radio_Buttonset extends WFOCUKirki_Control_Base {
		...
		protected function content_template() {
            ...
            <div id="input_{{ data.id }}" class="buttonset">
                ...
                <input {{{ data.inputAttrs }}} class="switch-input screen-reader-text" type="radio" value="{{ key }}" name="_customize-radio-{{{ data.id }}}" id="{{ data.id }}{{ key }}" {{{ data.link }}}<#
