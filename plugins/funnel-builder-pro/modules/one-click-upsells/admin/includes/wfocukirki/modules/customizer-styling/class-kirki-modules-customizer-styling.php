 ...
 * based on the settings set using the wfocukirki_config filter.
...
if ( ! class_exists( 'WFOCUKirki_Modules_Customizer_Styling' ) ) {
	/**
	...
	class WFOCUKirki_Modules_Customizer_Styling {
		...
		public function custom_css() {
            ...
            <style>
                ...
                .customize-control-wfocukirki-background .background-attachment .buttonset .switch-label,
                .customize-control-wfocukirki-background .background-size .buttonset .switch-label,
                .customize-control-wfocukirki-radio-buttonset .buttonset .switch-label {
                    color: <?php echo $text_on_back; // WPCS: XSS ok. ?>;
                }
                ...
                .customize-control-wfocukirki-slider input[type=range]::-webkit-slider-thumb {
                    background-color: <?php echo $accent; // WPCS: XSS ok. ?>;
                }

                .customize-control-wfocukirki-slider input[type=range]::-moz-range-thumb {
                    background-color: <?php echo $accent; // WPCS: XSS ok. ?>;
                }

                .customize-control-wfocukirki-slider input[type=range]::-ms-thumb {
                    background-color: <?php echo $accent; // WPCS: XSS ok. ?>;
                }

                .customize-control-wfocukirki-slider input[type=range] {
                ...
                .wfocukirki-reset-section .dashicons {
                ...
                .customize-control-wfocukirki-radio-buttonset .buttonset .switch-input:checked + .switch-label,
                .customize-control-wfocukirki-background .background-attachment .buttonset .switch-input:checked + .switch-label,
                .customize-control-wfocukirki-background .background-size .buttonset .switch-input:checked + .switch-label {
                    background-color: <?php echo $accent; // WPCS: XSS ok. ?>;
                    border-color: <?php echo $border_on_accent; // WPCS: XSS ok. ?>;
                    color: <?php echo $text_on_accent; // WPCS: XSS ok. ?>;
                }
