 ...
 */
?>
<div class="bwfabt-exp-delete-confirmation">
    <div class="wfabt_popup_header">
        <div class="wfabt_pop_title"><?php esc_attr_e( 'Delete Experiment', 'woofunnels-ab-tests' ); ?></div>
    ...
    <div id="modal-ajax5">
        ...
        <div class="bwfabt_pop_body">
            ...
            <div class="bwfabt_row wfabt_txt_center">
                <div class="wfabt_h3">Are you sure you want to delete!</div>
                <div class="wfabt_p"><?php esc_html_e( 'This action cannot be undone.', 'woofunnels-ab-tests' ); ?></div>
            </div>

            <div class="bwfabt_clear_20"></div>
            <div class="bwfabt_row wfabt_txt_center ">
                <a class="wfabt_btn wfabt_btn_red bwfabt_delete_exp" href="javascript:void(0);">
...
<!-- Step-2 Deleting     -->
<div class="bwfabt_pop_body bwfabt-experiment-deleting bwfabt-hide">
    <div class="bwfabt_row wfabt_txt_center">

        <div class="bwfabt-deleting-variant">
            <div class="bwfabt_pop_icon"><img src="<?php echo esc_url( BWFABT_PLUGIN_URL ) ?>/assets/img/readiness-loader.gif"></div>
            <div class="wfabt_h3"><?php esc_html_e( 'Please wait for a few moments! ', 'woofunnels-ab-tests' ); ?></div>
            <div class="wfabt_p"><?php esc_html_e( 'Deleting this experiment and all its variants.....', 'woofunnels-ab-tests' ); ?></div>
        </div>

    </div>
</div>
<!-- Step-3 Deleted -->
<div class="bwfabt_pop_body bwfabt-experiment-deleted bwfabt-hide">
    <div class="bwfabt_row wfabt_txt_center">
        <div class="bwfabt_pop_icon">
            ...
            <div class="wfabt_h3"><?php esc_html_e( 'The experiment and all its variants are deleted successfully.', 'woofunnels-ab-tests' ); ?> </div>
        </div>
    </div>
</div>
