...
/**
 * Reseting stats model
 */
?>
<div id="part_reset_stats_vue" class="bwfabt-pop bwfabt-pop-common">
    <div class="">
        <div class="bwfabt_pop_body">
            <div class="wfabt_reset_stats wfabt_announce">
                <div id="modal-ajax5" style="padding: 0px;">

                    <!-- Step-1 Taking consent -->
                    <div v-if="`reset`===reset_status" class="bwfabt-confirmation ">
                        ...
                        <div class="bwfabt_row wfabt_txt_center">
                            <div class="wfabt_h3">
								<?php esc_html_e( 'Are you sure you want to reset the experiment?', 'woofunnels-ab-tests' ); ?></div>

                            <div class="wfabt_p">
								<?php esc_html_e( 'This action cannot be undone.', 'woofunnels-ab-tests' ); ?>
                            </div>
                        ...
                        <div class="bwfabt_row wfabt_txt_center ">
                            <a v-on:click="resetStats()" class="wfabt_btn wfabt_btn_success" href="javascript:void(0);">
                                <span class="animate_btn"></span>
								<?php esc_html_e( 'Confirm reset', 'woofunnels-ab-tests' ); ?>
                            </a>
                    ...
                    <!-- Step-2 Reseting -->
                    <div v-if="`resetting`===reset_status" v-bind:class="(`resetting`===reset_status)?` bwfabt_disp_show`:``" class="bwfabt_disp_none ">
                        <div class="bwfabt-reseting-stats">
                            <div class="bwfabt_row wfabt_txt_center">
                    ...
                    <div v-if="`reset_complete`===reset_status" v-bind:class="(`reset_complete`===reset_status)?` bwfabt_disp_show`:``" class="bwfabt_disp_none">
                        <div class="bwfabt_row wfabt_txt_center">
                        ...
                        <div class="bwfabt_row wfabt_txt_center">
                            <div class="wfabt_h3"><?php esc_html_e( 'Done! All the records have been successfully reset.', 'woofunnels-ab-tests' ); ?> </div>
                        </div>
                    </div>
