...
if ( ! class_exists( 'WC_SC_Admin_Welcome' ) ) {
	...
	class WC_SC_Admin_Welcome {
		...
		public function admin_head() {
			...
			if ( ! empty( $get_page ) && ( 'sc-faqs' === $get_page || 'sc-tour' === $get_page || 'sc-about' === $get_page ) ) {
				?>
			<style type="text/css">
				/*<![CDATA[*/
				.about-wrap h3 {
		...
		private function intro() {
			...
			<div class="has-2-columns feature-section col two-col" style="margin-bottom: 30px !important;">
				<div class="is-vertically-aligned-center column col">
					...
					<a href="<?php echo esc_url( add_query_arg( array( 'page' => 'sc-tour' ), admin_url( 'admin.php' ) ) ); ?>" class="button button-hero"><?php echo esc_html__( 'Take a tour', 'woocommerce-smart-coupons' ); ?></a>
					<?php } ?>
					<?php /* translators: HTML entity for Right-arrow */ ?>
					<a href="<?php echo esc_url( add_query_arg( array( 'post_type' => 'shop_coupon' ), admin_url( 'edit.php' ) ) ); ?>" class="button button-primary"><?php echo sprintf( esc_html__( 'Go to Coupons dashboard %s', 'woocommerce-smart-coupons' ), '&xrarr;' ); ?></a>
				</div>
			...
			<h2 class="nav-tab-wrapper">
				...
				" href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'sc-tour' ), 'admin.php' ) ) ); ?>">
					<?php echo esc_html__( 'DIY Tour', 'woocommerce-smart-coupons' ); ?>
				</a>
				<?php } ?>
				<a class="nav-tab 
				<?php
			...
			<div class="wc-sc-grid-container">
				<div class="wc-sc-grid-item">
					<div class="icon-title-wrapper">
						...
						<h3><?php esc_html_e( 'How to Configure BOGO', 'woocommerce-smart-coupons' ); ?></h3>
					</div>
				...
				<div class="wc-sc-grid-item">
					<div class="icon-title-wrapper">
						<span class="dashicons dashicons-lightbulb"></span>
						<h3><?php esc_html_e( 'Configure fixed denomination Gift Cards', 'woocommerce-smart-coupons' ); ?></h3>
					</div>
				...
				<div class="wc-sc-grid-item">
					<div class="icon-title-wrapper">
						<span class="dashicons dashicons-lightbulb"></span>
						<h3><?php esc_html_e( 'Configure any denomination Gift Cards', 'woocommerce-smart-coupons' ); ?></h3>
					</div>
				...
				<div class="wc-sc-grid-item">
					<div class="icon-title-wrapper">
						<span class="dashicons dashicons-lightbulb"></span>
						<h3><?php esc_html_e( 'Configure discounted price Gift Cards', 'woocommerce-smart-coupons' ); ?></h3>
					</div>
