<div class="woocommerce_gpf_settings">
	...
	<div style="position: relative;">
		...
		<div">
			...
			<p><?php
				// Translators: %1$s and %2$s are <a></a> tags for refresh link.
				printf( esc_html( __( 'Choose the fields you want to include here, and also set store-wide defaults. You can also set defaults against categories, or provide information on each product page. You can choose to have the product feed data prepopulated from existing taxonomies, or fields. If you add a new custom field then you may need to %1$srefresh the field list%2$s before it will be available for selection.', 'woocommerce_gpf' ) ), '<a href="{refresh_fields_url}">', '</a>' );
			?></p>
