 ...
 [for Shopping Actions integration]',
	...
	private function get_prepopulate_fields() {
		$fields = [
			...
			'field:global_unique_id' => __( '"GTIN, UPC, EAN or ISBN" field', 'woocommerce_gpf' ),
		...
		if ( defined( 'WC_VERSION' ) && version_compare( WC_VERSION, '9.9.0', 'ge' ) ) {
			$fields['field:cogs'] = __( 'Cost of Goods sold field', 'woocommerce_gpf' );
		}
