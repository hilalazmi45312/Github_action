...
/**
 * Facebook CAPI adapter for server-side event processing
 *
 * Handles filtering and sending events to Facebook Conversions API.
 * Also implements Pixel_Descriptor for unified pixel registry.
 *
 * @package SweetCode\Pixel_Manager\Pixels\Adapters\Facebook
 * @since 1.51.0
 */
class Facebook_Adapter extends Abstract_Pixel_Adapter implements Pixel_Descriptor {
	...
	public function is_active() {
		return \SweetCode\Pixel_Manager\Options::is_facebook_active();
	}
	...
	/**
	 * Check if Facebook CAPI is available
	 *
	 * @return bool
	 */
	public function is_available() {
		return class_exists( 'SweetCode\Pixel_Manager\Pixels\Facebook\Facebook_CAPI' );
	}
	...
	protected function send( $pixel_data ) {
		Facebook_CAPI::send_s2s_event( $pixel_data );
	}
}

// Auto-register the adapter
new Facebook_Adapter();
