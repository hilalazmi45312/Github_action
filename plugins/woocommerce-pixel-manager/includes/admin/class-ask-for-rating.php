...
//      update_option($this->option_name,$options);
		...
		add_action('admin_enqueue_scripts', array( $this, 'wpm_rating_script' ));
		add_action('wp_ajax_wpm_dismissed_notice_handler', array( $this, 'ajax_rating_notice_handler' ));
		add_action('admin_notices', array( $this, 'ask_for_rating_notice' ));
	}
	...
	private function show_admin_notifications() {
		...
		$show_admin_notifications = apply_filters_deprecated('wooptpm_show_admin_notifications', array( true ), '1.13.0', 'pmw_show_admin_notifications');
		$show_admin_notifications = apply_filters_deprecated('wpm_show_admin_notifications', array( $show_admin_notifications ), '1.31.2', 'pmw_show_admin_notifications');
			...
			<div style="color:#02830b; margin-top:10px">
				...
				<span>
						...
						/* translators: %d: the amount of purchase conversions that have been measured */
							esc_html__('Hey, I noticed that you tracked more than %d purchase conversions with the Pixel Manager Pro for WooCommerce plugin - that\'s awesome! Could you please do me a BIG favour and give it a 5-star rating on WordPress? It will help to spread the word and boost our motivation.', 'woocommerce-google-adwords-conversion-tracking-tag'),
