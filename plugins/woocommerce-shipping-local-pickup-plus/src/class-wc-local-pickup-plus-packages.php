...
class WC_Local_Pickup_Plus_Packages {
		...
		return [
			...
			'destination'     => $this->get_package_destination_address(
				[
					...
					'address_1' => WC()->customer->get_billing_address_1(), // provide both address_1 field keys for backwards compatibility
				...
				[
					...
					'address_1' => WC()->customer->get_shipping_address_1(), // provide both address_1 field keys for backwards compatibility
	...
	public function handle_packages( $packages ) {
		...
		if ( ! empty( $packages ) && isset($packages[0]) && $local_pickup_plus->is_available() ) {
