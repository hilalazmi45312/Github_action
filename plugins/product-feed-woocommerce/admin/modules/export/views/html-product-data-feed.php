...
<div id="wt_feed_data" class="panel woocommerce_options_panel">
		...
		if ( ! $discard_val ) {
			$discard_val = get_post_meta( $post->ID, '_wt_facebook_discard', true );
		}
		if ( ! $discard_val ) {
			$discard_val = get_post_meta( $post->ID, '_wt_google_discard', true );
		}
		...
		woocommerce_wp_checkbox(
			array(
				...
				'label'       => _x(
					'Exclude from feed',
					'product data setting title',
					'product-feed-woocommerce'
				),
				'description' => _x(
					'Enable the checkbox to exclude the product from the feed.',
					'product data setting desc',
					'product-feed-woocommerce'
				),
				'desc_tip'    => false,
				'value'       => $discard_val,
	...
	<div class="options_group">
		...
		woocommerce_wp_text_input(
			array(
				'id'          => '_wt_feed_brand',
				'label'       => _x( 'Brand', 'product data setting title', 'product-feed-woocommerce' ),
				'description' => _x( 'The brand of the product.', 'product data setting desc', 'product-feed-woocommerce' ),
				'desc_tip'    => true,
				'value'       => $brand_val,
			)
		);
		...
		woocommerce_wp_text_input(
			array(
				'id' => '_wt_feed_gtin',
				'label' => __( 'GTIN', 'product-feed-woocommerce' ),
				'desc_tip' => true,
				'description' => _x( 'The Global Trade Item Number (GTIN) is an identifier for trade items.', 'product data setting desc', 'product-feed-woocommerce' ),
				'value' => $gtin_val,
			)
		);
		...
		woocommerce_wp_text_input(
			array(
				'id' => '_wt_feed_mpn',
				'label' => __( 'MPN', 'product-feed-woocommerce' ),
				'desc_tip' => true,
				'description' => _x( 'A manufacturer part number (MPN) is a series of numbers and/or letters given to a part by its manufacturer.', 'product data setting desc', 'product-feed-woocommerce' ),
				'value' => $mpn_val,
			)
		);
		...
		woocommerce_wp_select(
			array(
				...
				'label' => _x( 'Age group', 'product data setting title', 'product-feed-woocommerce' ),
				'description' => _x( 'The product age group.', 'product data setting desc', 'product-feed-woocommerce' ),
				'desc_tip' => true,
				'options' => array( '' => _x( 'Default', 'setting option', 'product-feed-woocommerce' ) ) + $age_group,
				'value' => $agegroup_val,
			)
		);
		...
		woocommerce_wp_select(
			array(
				'id' => '_wt_feed_gender',
				'label' => _x( 'Gender', 'product data setting title', 'product-feed-woocommerce' ),
				'description' => _x( 'The product gender.', 'product data setting desc', 'product-feed-woocommerce' ),
				'desc_tip' => true,
				'options' => array( '' => _x( 'Default', 'setting option', 'product-feed-woocommerce' ) ) + $product_gender,
				'value' => $gender_val,
			)
		);
		...
		woocommerce_wp_text_input(
			array(
				'id' => '_wt_feed_size',
				'label' => _x( 'Size', 'product data setting title', 'product-feed-woocommerce' ),
				'description' => _x( 'The size of the item. Enter the size as a word, abbreviation or number, such as "small", "XL", "12" or "one size". Character limit: 200. eg:- Medium', 'product data setting desc', 'product-feed-woocommerce' ),
				'desc_tip' => true,
				'value' => $size_val,
			)
		);
		...
		woocommerce_wp_text_input(
			array(
				'id' => '_wt_feed_color',
				'label' => _x( 'Color', 'product data setting title', 'product-feed-woocommerce' ),
				'description' => _x( 'The main colour of the item. Describe the colour in words, not a hex code. Character limit: 200. eg:- Royal blue', 'product data setting desc', 'product-feed-woocommerce' ),
				'desc_tip' => true,
				'value' => $color_val,
			)
		);
		...
		woocommerce_wp_text_input(
			array(
				...
				'description' => _x(
					'The material the item is made from, such as cotton, polyester, denim or leather. Character limit: 200. eg:- leather',
					'product data setting desc',
					'product-feed-woocommerce'
				),
				'desc_tip'    => true,
		...
		woocommerce_wp_text_input(
			array(
				...
				'description' => _x(
					'The pattern or graphic print on the item. Character limit: 100. eg:- striped',
					'product data setting desc',
					'product-feed-woocommerce'
				),
				'desc_tip'    => true,
		...
		woocommerce_wp_text_input(
			array(
				...
				'label' => _x( 'Unit pricing measure', 'product data setting title', 'product-feed-woocommerce' ),
				'description' => _x( 'Use the unit pricing measure [unit_pricing_measure] attribute to define the measure and dimension of your product. This value allows users to understand the exact cost per unit for your product.', 'product data setting desc', 'product-feed-woocommerce' ),
				'desc_tip' => true,
		...
		woocommerce_wp_text_input(
			array(
				...
				'label' => _x( 'Unit pricing base measure', 'product data setting title', 'product-feed-woocommerce' ),
				'description' => _x( 'The unit pricing base measure [unit_pricing_base_measure] attribute lets you include the denominator for your unit price. For example, you might be selling "150ml" of perfume, but customers are interested in seeing the price per "100ml".', 'product data setting desc', 'product-feed-woocommerce' ),
				'desc_tip' => true,
		...
		woocommerce_wp_text_input(
			array(
				...
				'description' => _x(
					'The [energy_efficiency_class] attributes to tell customers the energy label of your product.',
					'product data setting desc',
					'product-feed-woocommerce'
				),
				'desc_tip'    => true,
		...
		woocommerce_wp_text_input(
			array(
				...
				'description' => _x(
					'The [min_energy_efficiency_class] attributes to tell customers the energy label of your product.',
					'product data setting desc',
					'product-feed-woocommerce'
				),
				'desc_tip'    => true,
		...
		woocommerce_wp_text_input(
			array(
				...
				'description' => _x(
					'The [max_energy_efficiency_class] attributes to tell customers the energy label of your product.',
					'product data setting desc',
					'product-feed-woocommerce'
				),
				'desc_tip'    => true,
		...
		woocommerce_wp_select(
			array(
				...
				'description' => _x(
					'The product Pickup method, used in google local product inventory.',
					'product data setting desc',
					'product-feed-woocommerce'
				),
				'desc_tip'    => true,
		...
		woocommerce_wp_select(
			array(
				...
				'description' => _x(
					'The product Pickup SLA, used in google local product inventorr.',
					'product data setting desc',
					'product-feed-woocommerce'
				),
				'desc_tip'    => true,
			...
			$custom_label_0 = get_post_meta( $post->ID, '_wt_google_custom_label_0', true );
				...
				woocommerce_wp_text_input(
					array(
						...
						'description' => _x(
							'Additional custom label for the item. Character limit: 100. eg:- Summer Sale',
							'product data setting desc',
							'product-feed-woocommerce'
						),
						'desc_tip'    => true,
