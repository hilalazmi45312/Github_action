 ...
 *
 * @package   Webtoffee_Product_Feed_Sync_Pro\Admin\Modules\Google
 * @version   1.0.0
 */
...
if ( ! class_exists( 'Webtoffee_Product_Feed_Sync_Pro_Google_Export' ) ) {
	/**
	 * Webtoffee_Product_Feed_Sync_Pro_Google_Export Class.
	 */
	class Webtoffee_Product_Feed_Sync_Pro_Google_Export extends Product_Feed_For_Woocommerce_Product {
		/**
		...
		/**
		 * Filter the product feed product title with variation attribute.
		 *
		 * @since 1.0.0
		 *
		...
		public function description_with_html( $catalog_attr, $product_attr, $export_columns ) {
			 ...
			 * @since 1.0.0
			 *
			 * @param string $description Product description with HTML tags.
			 * @param object $product Product.
			 */
		...
		public function primary_category_id( $catalog_attr, $product_attr, $export_columns ) {
			...
			/**
			 * Filter the product feed product parent title.
			 *
			 * @since 1.0.0
			 *
			 * @param string $parent_category_id Product parent category id.
			 * @param object $product Product.
			 */
		...
		public function get_shipping() {
			 ...
			 * @since 1.0.0
			 *
			 * @param array $shipping_info Product shipping info.
			 * @param object $product Product.
			 */
		...
		public function color( $catalog_attr, $product_attr, $export_columns ) {
			 ...
			 * @param object $product Product.
			 */
			return apply_filters( 'wt_feed_product_google_color', $color, $this->product );
		}
		/**
		...
		public function rating_total( $catalog_attr, $product_attr, $export_columns ) {
			 ...
			 * @since 1.0.0
			 *
			 * @param int $rating_total Rating total.
			 * @param object $product Product.
			 */
		...
		public function rating_average( $catalog_attr, $product_attr, $export_columns ) {
			 ...
			 * @since 1.0.0
			 *
			 * @param float $rating_average Rating average.
			 * @param object $product Product.
			 */
		...
		public function item_group_id( $catalog_attr, $product_attr, $export_columns ) {
			 ...
			 * @since 1.0.0
			 *
			 * @param int $item_group_id Item group ID.
			 * @param object $product Product.
			 */
		...
		public function shipping( $catalog_attr, $product_attr, $export_columns, $key = '' ) {
			...
			if ( isset( $this->form_data['advanced_form_data']['wt_pf_file_as'] ) && 'xml' === $this->form_data['advanced_form_data']['wt_pf_file_as'] ) {
				/**
				 * Filter the product shipping details XML.
				 *
				 * @since 1.0.0
				 *
