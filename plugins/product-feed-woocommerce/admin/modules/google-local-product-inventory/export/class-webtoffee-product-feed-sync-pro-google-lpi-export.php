<?php
/**
 * Handles the Google lpi export actions.
 *
 * @package   Webtoffee_Product_Feed_Sync_Pro\Admin\Modules\GoogleLPI
 * @version   1.0.0
 */
...
if ( ! class_exists( 'Webtoffee_Product_Feed_Sync_Pro_Google_LPI_Export' ) ) {
	/**
	 * Webtoffee_Product_Feed_Google_LPI_Export Class.
	 */
	class Webtoffee_Product_Feed_Sync_Pro_Google_LPI_Export extends Product_Feed_For_Woocommerce_Product {
		/**
		...
		public function first_variation_price() {
			 ...
			 * @since 1.0.0
			 *
			 * @param float $price First variation price.
			 * @param object $product Product.
			 */
