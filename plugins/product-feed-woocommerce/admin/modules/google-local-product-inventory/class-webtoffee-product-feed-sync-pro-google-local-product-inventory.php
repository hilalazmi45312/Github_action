<?php
/**
 * Google Local Product Inventory product feed module
 *
 * @link
 *
 * @package  Webtoffee_Product_Feed_Sync_Pro_Google_Local_Product_Inventory
 */
...
if ( ! class_exists( 'Webtoffee_Product_Feed_Sync_Pro_Google_Local_Product_Inventory' ) ) {
	/**
	 * Webtoffee_Product_Feed_Sync_Pro_Google_Local_Product_Inventory Class.
	 */
	class Webtoffee_Product_Feed_Sync_Pro_Google_Local_Product_Inventory {
		 ...
		 * @param string $to_export or aka $to_export facebook, google etc.
		 * @return array $steps
		 */
		...
		public function exporter_do_export( $export_data, $base, $step, $form_data, $selected_template_data, $method_export, $batch_offset ) {
			...
			include plugin_dir_path( __FILE__ ) . 'export/class-webtoffee-product-feed-sync-pro-google-lpi-export.php';
			$export = new Webtoffee_Product_Feed_Sync_Pro_Google_LPI_Export( $this );
		...
		public function wt_pf_exporter_post_types_basic( $arr ) {
			...
			$arr['google_local_product_inventory'] = __(
...
new Webtoffee_Product_Feed_Sync_Pro_Google_Local_Product_Inventory();
