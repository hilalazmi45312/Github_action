...
if ( ! class_exists( 'Webtoffee_Product_Feed_Sync_Pro_Pinterest' ) ) {
	/**
	 * Webtoffee_Product_Feed_Sync_Pro_Pinterest Class.
	 */
	class Webtoffee_Product_Feed_Sync_Pro_Pinterest {
		...
		public function exporter_do_export( $export_data, $base, $step, $form_data, $selected_template_data, $method_export, $batch_offset ) {
			...
			include plugin_dir_path( __FILE__ ) . 'export/class-webtoffee-product-feed-sync-pro-pinterest-export.php';
		...
		public static function get_product_statuses() {
			...
			/**
			 * Filter the allowed product statuses.
			 *
			 * @since 1.0.0
			 *
		...
		public static function wt_feed_get_product_conditions() {
			...
			/**
			 * Filter the Pinterest product conditions.
			 *
			 * @since 1.0.0
			 *
		...
		public static function get_age_group() {
			...
			/**
			 * Filter the Pinterest product age groups.
			 *
			 * @since 1.0.0
			 *
			 * @param array $pinterest_age_group Age groups.
			 */
