<?php
/**
 * Handles the Pinterest export actions.
 *
 * @package   Webtoffee_Product_Feed_Sync_Pro\Admin\Modules\Pinterest
 * @version   1.0.0
 */
...
if ( ! class_exists( 'Webtoffee_Product_Feed_Sync_Pro_Pinterest_Export' ) ) {
	/**
	 * Webtoffee_Product_Feed_Sync_Pro_Pinterest_Export Class.
	 */
	class Webtoffee_Product_Feed_Sync_Pro_Pinterest_Export extends Product_Feed_For_Woocommerce_Product {
		/**
		...
		public function prepare_data_to_export( $form_data, $batch_offset, $step ) {
			...
			/**
			 * Filter the batch count for CSV export.
			 *
			 * @since 1.0.0
			 *
		...
		public function title( $catalog_attr, $product_attr, $export_columns ) {
			...
			if ( $this->product->is_type( 'variation' ) && ! empty( $this->product->get_attributes() ) ) {
				...
				/**
				 * Filter the product title with variation attributes.
				 *
				 * @since 1.0.0
				 *
				 * @param bool $get_with_var_attributes Whether to get product title with variation attributes.
				 * @param object $product Product object.
				 */
		...
		public function google_product_category( $catalog_attr, $product_attr, $export_columns ) {
				...
				foreach ( $category_path as $category ) {
					...
					if ( $pinterest_category_id ) {
						...
						if ( false === $pinterest_category_list ) {
							$pinterest_category_list             = Webtoffee_Product_Feed_Sync_Pro_Pinterest::get_category_array();
			 ...
			 * @since 1.0.0
			 *
			 * @param string $pinterest_product_category Product google category.
			 * @param object $product Product object.
			 */
		 ...
		 * @param array $product_attr Product attributes.
		 * @param array $export_columns Export columns.
		 * @param array $additional_img Export additional img.
		 * @return string
		 */
		...
		public function number_of_reviews( $catalog_attr, $product_attr, $export_columns ) {
			 ...
			 * @since 1.0.0
			 *
			 * @param string $review_count Product number of reviews.
			 * @param object $product Product object.
			 */
		...
		public function mpn( $catalog_attr, $product_attr, $export_columns ) {
			...
			/**
			 * Filter the product idex.
			 *
			 * @since 1.0.0
			 *
			 * @param string $identifier_exists Product idex.
			 * @param object $product Product object.
			 */
