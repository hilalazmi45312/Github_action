...
if ( ! class_exists( 'Webtoffee_Product_Feed_Sync_Pro_Facebook' ) ) {
	...
	class Webtoffee_Product_Feed_Sync_Pro_Facebook {
		...
		<tr class="form-field">
			<th scope="row" valign="top"><label for="wt_fb_category">Facebook Category</label></th>
			<td>
				<select name="wt_fb_category" style="width:100%">
			<?php
								$allowed_tags = array(
									'select' => array(
										'id' => array(),
								...
								echo wp_kses( $this->wt_fb_category_dropdown( $fb_category_id ), $allowed_tags );
								?>
				</select>

				<p class="description"><?php esc_html_e( 'The Facebook Category corresponding to this category in the website.', 'product-feed-woocommerce' ); ?>
				</p>
			</td>
		</tr>
		...
		public function exporter_do_export( $export_data, $base, $step, $form_data, $selected_template_data, $method_export, $batch_offset ) {
			...
			include plugin_dir_path( __FILE__ ) . 'export/class-webtoffee-product-feed-sync-pro-facebook-export.php';
		...
		public static function get_age_group() {
			 ...
			 * @since 1.0.0
			 *
			 * @param array $fb_age_group Age groups.
			 */
		...
		public static function get_category_array() {
			...
			if ( false === $taxonomy ) {
				$file_name = WT_PRODUCT_FEED_PRO_PLUGIN_PATH . '/admin/modules/facebook/data/fb_taxonomy.txt';
		 ...
		 * @return string
		 */
		public function wt_fb_category_dropdown( $selected = '' ) {
