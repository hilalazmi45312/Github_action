<?php
/**
 * Bing Shopping product feed module
 *
 * @link
 *
...
if ( ! class_exists( 'Webtoffee_Product_Feed_Sync_Pro_Bing' ) ) {
	/**
	 * Webtoffee Product Feed Sync Pro Bing.
	 */
	class Webtoffee_Product_Feed_Sync_Pro_Bing {
		...
		/**
		 * Webtoffee Product Feed Sync Pro Bing Category Form Fields.
		 *
		...
		public function exporter_do_export( $export_data, $base, $step, $form_data, $selected_template_data, $method_export, $batch_offset ) {
			...
			include plugin_dir_path( __FILE__ ) . 'export/class-webtoffee-product-feed-sync-pro-bing-export.php';
		...
		public function wt_pf_exporter_post_types_basic( $arr ) {
			...
			$arr['bing'] = __( 'Bing Shopping', 'product-feed-woocommerce' );
			return $arr;
		}
		...
		public function exporter_alter_mapping_enabled_fields( $mapping_enabled_fields, $base, $form_data_mapping_enabled_fields ) {
			if ( $base == $this->module_base ) {
				...
				$mapping_enabled_fields['tax_shipping'] = array( __( 'Shipping', 'product-feed-woocommerce' ), 1 );
		 ...
		 * @return array $attribute_dropdown
		 */
		...
		public static function get_age_group() {
			 ...
			 * @since 1.0.0
			 *
			 * @param array   $google_age_group    Google age group.
			 * @param object $product Product.
			 */
