...
var wt_saved_templates = {
    Set: function()
	{ 
                jQuery('.wt_ier_delete_template').off('click').on('click', function (e) {
                    e.preventDefault();                    
...
wt_pf_popup={
	...
	regPopupClose:function(popup_elm)
	{
		...
		jQuery('.wt_pf_popup_close, .wt_pf_popup_cancel, .wt_pf_popup_close_btn').off('click').on('click', function(){
...
var wt_pf_popover=
{
	...
	Set:function()
	{
		jQuery('[data-wt_pf_popover="1"]').off('click').on('click', function(){
	...
	do_action:function()
	{	
		jQuery('[name="wt_pf_popover_do_action"]').off('click').on('click', function(){
	...
	regclosePop:function()
	{
		...
		jQuery('.popover_close').off('click').on('click', function(){
			wt_pf_popover.closePop();
		});
	},
...
var wt_pf_custom_and_preset=
{
	toggler:function(preset_elm, custom_elm, custom_val) /* Toggle between custom and preset value */
	{
		...
		preset_elm.off('change').on('change', function(){
