...
class Google_MP_GA4 extends S2S {
	...
	private static function hook_into_order_status_change_event() {
		add_action('woocommerce_order_status_changed', [ __CLASS__, 'pmw_woocommerce_order_status_changed' ], 10, 4);
	}
	...
	private static function hook_into_refund_events() {
		add_action('woocommerce_order_fully_refunded', [ __CLASS__, 'google_analytics_mp_send_full_refund' ], 10, 2);
		add_action('woocommerce_order_partially_refunded', [ __CLASS__, 'google_analytics_mp_send_partial_refund' ], 10, 2);
	}
	...
	private static function hook_into_subscriptions_events() {
		add_action('woocommerce_subscription_renewal_payment_complete', [ __CLASS__, 'google_analytics_mp_report_subscription_purchase_renewal' ], 10, 2);
	}
...
//		}
	...
	private static function is_ga_cid_logger_active() {
		...
		$logger_active = apply_filters_deprecated('wooptpm_get_ga_cid_logger', [ false ], '1.13.0', 'pmw_ga_cid_log_activation');
		$logger_active = apply_filters_deprecated('wpm_get_ga_cid_logger', [ $logger_active ], '1.31.2', 'pmw_ga_cid_log_activation');
	...
	private static function is_filter_pmw_ga_cid_logger_active() {
		...
		$logger_active = apply_filters_deprecated('wooptpm_get_ga_cid_logger', [ false ], '1.13.0', 'pmw_ga_cid_logger');
		$logger_active = apply_filters_deprecated('wpm_get_ga_cid_logger', [ $logger_active ], '1.31.2', 'pmw_ga_cid_logger');
