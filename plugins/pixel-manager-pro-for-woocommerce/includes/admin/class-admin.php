...
class Admin {
			...
			if (Helpers::can_order_modal_be_shown()) {
				...
				add_action('add_meta_boxes', function () {
					...
					add_meta_box(
						...
						[ __CLASS__, 'pmw_order_modal__premium_only' ],
						$screen,
						'side',
						'core'
					);
	...
	public static function plugin_admin_init() {
		...
		register_setting(
			...
			[ '\SweetCode\Pixel_Manager\Admin\Validations', 'options_validate' ]
		);
					...
					<div>
						...
						<label class="switch" id="pmw-pro-version-demo">
							...
							<input type="checkbox"
								...
								<?php checked(Options::is_pro_version_demo_active()); ?>
							/>
	...
	public static function setting_linkedin_search() {
		...
		<input class="pmw mono"
			   ...
			   type="text"
			   value="<?php echo esc_html(Options::get_linkedin_conversion_id('search')); ?>"
	...
	public static function setting_linkedin_add_to_list() {
		...
		<input class="pmw mono"
			   ...
			   size="<?php echo esc_html($text_length); ?>"
			   type="text"
			   value="<?php echo esc_html(Options::get_linkedin_conversion_id('add_to_list')); ?>"
			   style="width:<?php echo esc_html($text_length); ?>ch"
			<?php echo esc_html(self::disable_if_demo()); ?>
			   onclick="this.select();"
		/>
	...
	public static function setting_linkedin_start_checkout() {
		...
		<input class="pmw mono"
			   ...
			   size="<?php echo esc_html($text_length); ?>"
			   type="text"
			   value="<?php echo esc_html(Options::get_linkedin_conversion_id('start_checkout')); ?>"
			   style="width:<?php echo esc_html($text_length); ?>ch"
			<?php echo esc_html(self::disable_if_demo()); ?>
			   onclick="this.select();"
		/>
	...
	public static function html_marketing_value_logic() {
		...
		<?php if (wpm_fs()->can_use_premium_code__premium_only() || '2' === Options::get_marketing_value_logic() || Options::is_pro_version_demo_active()) : ?>
			<br>
			<label>
				<input type="radio"
