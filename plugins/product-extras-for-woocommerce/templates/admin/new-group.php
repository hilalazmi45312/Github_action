		...
		<div class="pewc-all-fields-wrapper">
			<div class="pewc-group-meta-table wc-metabox">
				...
				<div class="form-row">
					...
					<div class="product-extra-field-two-thirds-right">
						<input type="checkbox" class="pewc-group-repeatable" name="" value="1" data-group-id="" />
					</div>
				</div>
				<div class="form-row pewc-repeatable-options pewc-repeatable-by-quantity hidden">
					<div class="product-extra-field-third">
						<label>
					...
					<div class="product-extra-field-two-thirds-right">
						<input type="checkbox" class="pewc-group-repeatable-by-quantity" name="" value="1" data-group-id="" />
					</div>
				</div>
				<div class="form-row pewc-repeatable-options pewc-repeatable-limit hidden">
					<div class="product-extra-field-third">
						<label>
					...
					<div class="product-extra-field-two-thirds-right">
						<input type="number" class="pewc-group-repeatable-limit" name="" value="0" />
					</div>
				</div>
