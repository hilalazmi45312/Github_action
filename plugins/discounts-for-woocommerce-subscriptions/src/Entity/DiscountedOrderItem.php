...
class DiscountedOrderItem {
	...
	public static function addDiscounts(
		...
		if ( ! empty( $discounts ) ) {
			...
			try {
				...
				$item->add_meta_data( '_dfws_original_product_price',
					$originalProductPrice ? $originalProductPrice : $item->get_product()->get_price() );
