...
class Frontend {
	...
	public function displayDiscountsTable() {
		...
		if ( $product ) {
			...
			} elseif ( in_array( $product->get_type(),
	...
	public function enqueueAssets() {
		...
		if ( is_product() ) {
			...
			wp_localize_script( 'discounts-for-woocommerce-subscriptions-front-js', 'subscriptionDiscountsData', array(
	...
	public function renderPricingTable( $product_id, $variation_id = null ) {
		...
		if ( DiscountsManager::isHideDisplayPricingTable( $product_id ) ) {
			return;
		}
