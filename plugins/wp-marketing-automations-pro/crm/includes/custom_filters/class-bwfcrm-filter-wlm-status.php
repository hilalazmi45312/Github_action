...
class BWFCRM_Filter_WLM_Status extends BWFCRM_Custom_Filter_Base {
	...
	public function where_query( $filter_where, $filter_key, $filter_rule, $filter_value ) {
		...
		BWFCRM_Integration_Wishlist_Member::add_contact_filter( 'status', $filter_rule, $filter_value );

		return $filter_where;
	}
}

$ins = BWFCRM_Filter_WLM_Status::get_instance();
