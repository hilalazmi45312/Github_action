...
class BWFCRM_Filter_AFFWP_Paid_Earnings extends BWFCRM_Custom_Filter_Base {
	...
	public function where_query( $filter_where, $filter_key, $filter_rule, $filter_value ) {
		...
		return "awp.earnings {$filter_rule} {$filter_value}";
	}
}

$ins = BWFCRM_Filter_AFFWP_Paid_Earnings::get_instance();
