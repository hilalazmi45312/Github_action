...
class BWFCRM_Filter_AFFWP_Unaid_Earnings extends BWFCRM_Custom_Filter_Base {
	private static $ins = null;

	/** @return BWFCRM_Filter_AFFWP_Unaid_Earnings */
	...
	public function __construct() {
		$this->name = 'affwp_unpaid_earning';
	...
	public function where_query( $filter_where, $filter_key, $filter_rule, $filter_value ) {
		...
		return "awp.unpaid_earnings {$filter_rule} {$filter_value}";
	}
}

$ins = BWFCRM_Filter_AFFWP_Unaid_Earnings::get_instance();
