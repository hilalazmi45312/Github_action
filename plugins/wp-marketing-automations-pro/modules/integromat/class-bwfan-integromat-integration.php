...
class BWFAN_Integromat_Integration extends BWFAN_Integration {

	private static $ins = null;

	public function __construct() {
		$this->action_dir = __DIR__;
		$this->nice_name  = __( 'Make (Integromat)', 'wp-marketing-automations-pro' );
	...
	public function handle_response( $result, $connector_slug, $action_call_class_slug, $action_data = null ) {
		...
		return array(
			'status'  => 4,
			'message' => __( 'Webhook not active in integromat.', 'wp-marketing-automations-pro' ),
		);
	}
 ...
 */
BWFAN_Load_Integrations::register( 'BWFAN_Integromat_Integration' );
