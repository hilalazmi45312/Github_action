...
final class BWFAN_Caldera_Form_Submit extends BWFAN_Event {
	...
	private function __construct() {
		$this->event_merge_tag_groups = array( 'calderaforms', 'bwf_contact' );
		$this->event_name             = esc_html__( 'Caldera Forms', 'wp-marketing-automations-pro' );
		...
		$this->optgroup_label         = esc_html__( 'Caldera Form', 'wp-marketing-automations-pro' );
		$this->priority               = 10;
	...
	public function validate_v2_event_settings( $automation_data ) {
		if ( absint( $automation_data['form_id'] ) !== absint( $automation_data['event_meta']['bwfan-caldera_form_submit_form_id'] ) ) {
			return false;
		}
	...
	public function get_fields_schema() {
		...
		return [
			[
				'id'          => 'bwfan-caldera_form_submit_form_id',
				'type'        => 'select',
				'options'     => $forms,
			...
			[
				...
				'placeholder' => __( 'Select', 'wp-marketing-automations-pro' ),
				"description" => "",
				"ajax_cb"     => 'bwfan_get_caldera_form_fields',
				"ajax_field"  => [
					'id' => 'bwfan-caldera_form_submit_form_id'
				],
				"fieldChange" => 'bwfan-caldera_form_submit_form_id',
				"toggler"     => [
					'fields'   => array(
						array(
							'id'    => 'bwfan-caldera_form_submit_form_id',
