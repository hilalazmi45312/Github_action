...
final class BWFAN_Pabbly_Send_Data extends BWFAN_Action {

	private static $ins = null;
	public $required_fields = array( 'url', 'custom_fields' );

	private function __construct() {
		$this->action_name = __( 'Send Data To Pabbly', 'wp-marketing-automations-pro' );
		$this->action_desc = __( 'This action sends key/ value pair data to the Pabbly', 'wp-marketing-automations-pro' );
	...
	public function get_fields_schema() {
		return [
			...
			[
				...
				"hint"        => __( "This will POST the key value pairs with dummy data to Pabbly Webhook URL", 'wp-marketing-automations-pro' )
			],
		];
	}
}

return 'BWFAN_Pabbly_Send_Data';
