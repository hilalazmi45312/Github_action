...
class BWFAN_Pabbly_Integration extends BWFAN_Integration {

	private static $ins = null;

	public function __construct() {
		$this->action_dir = __DIR__;
		$this->nice_name  = __( 'Pabbly', 'wp-marketing-automations-pro' );
	...
	public function handle_response( $result, $connector_slug, $action_call_class_slug, $action_data = null ) {
		...
		return array(
			'status'  => 4,
			'message' => __( 'Webhook not active in pabbly.', 'wp-marketing-automations-pro' ),
		);
	}
 ...
 */
BWFAN_Load_Integrations::register( 'BWFAN_Pabbly_Integration' );
