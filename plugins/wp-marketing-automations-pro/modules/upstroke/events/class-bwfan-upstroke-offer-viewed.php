...
final class BWFAN_UpStroke_Offer_Viewed extends BWFAN_Event {
	...
	private function __construct() {
		...
		$this->event_name        = esc_html__( 'Offer Viewed', 'wp-marketing-automations-pro' );
		$this->event_desc        = esc_html__( 'This event runs after an offer is viewed by the customer.', 'wp-marketing-automations-pro' );
