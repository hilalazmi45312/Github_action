...
final class BWFAN_Yith_Wishlist_Item_Onsale extends BWFAN_Event {
	...
	public function load_hooks() {
		if ( ! bwf_has_action_scheduled( 'bwfan_yith_wishlist_on_item_sale' ) ) {
			bwf_schedule_recurring_action( time(), MINUTE_IN_SECONDS * 30, 'bwfan_yith_wishlist_on_item_sale', null, 'autonami' );
		}
		add_action( 'bwfan_yith_wishlist_on_item_sale', [ $this, 'capture_wishlist_data' ], 10 );
	}
...
if ( bwfan_is_woocommerce_active() && function_exists( 'bwfan_is_yith_wishlist_active' ) && bwfan_is_yith_wishlist_active() ) {
	return 'BWFAN_Yith_Wishlist_Item_Onsale';
}
