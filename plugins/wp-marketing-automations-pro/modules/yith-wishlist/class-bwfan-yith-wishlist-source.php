...
class BWFAN_Yith_Wishlist_Source extends BWFAN_Source {
	private static $instance = null;

	public function __construct() {
		$this->event_dir  = __DIR__;
		$this->nice_name  = __( 'Yith Wishlist', 'wp-marketing-automations-pro' );
	 ...
	 *
	 * @return BWFAN_Yith_Wishlist_Source|null
	 */
...
if ( bwfan_is_woocommerce_active() && function_exists( 'bwfan_is_yith_wishlist_active' ) && bwfan_is_yith_wishlist_active() ) {
	BWFAN_Load_Sources::register( 'BWFAN_Yith_Wishlist_Source' );
}
