...
final class BWFAN_Ti_Wc_Wishlist_Reminder extends BWFAN_Event {
	...
	public function make_task_data( $automation_id, $automation_data ) {
		...
		global $wpdb;
		$query   = "SELECT lists.ID AS wishlist_id, lists.author AS user_id, GROUP_CONCAT(items.product_id) AS wishlist_items 
...
if ( bwfan_is_woocommerce_active() && function_exists( 'bwfan_is_ti_wc_wishlist_active' ) && bwfan_is_ti_wc_wishlist_active() ) {
	return 'BWFAN_Ti_Wc_Wishlist_Reminder';
}
