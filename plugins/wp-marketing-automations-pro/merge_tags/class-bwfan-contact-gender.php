...
if ( ! BWFAN_PRO_Common::is_lite_3_0() && ! class_exists( 'BWFAN_Contact_Gender' ) ) {
	class BWFAN_Contact_Gender extends BWFAN_Merge_Tag {
		...
		public function __construct() {
			...
			$this->tag_description = __( 'Contact Gender', 'wp-marketing-automations-pro' );
	 ...
	 */
	BWFAN_Merge_Tag_Loader::register( 'bwf_contact', 'BWFAN_Contact_Gender', null, __( 'Contact', 'wp-marketing-automations-pro' ) );
}