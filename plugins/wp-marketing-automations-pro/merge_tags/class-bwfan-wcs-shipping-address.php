...
class BWFAN_WCS_Shipping_Address extends BWFAN_Merge_Tag {
	...
	public function __construct() {
		...
		$this->tag_description = __( 'Subscription Shipping Address', 'wp-marketing-automations-pro' );
	...
	public function get_dummy_preview() {
		return __( 'John Marsh Ashok Nagar, Delhi 110022, India', 'wp-marketing-automations-pro' );
	}
...
if ( bwfan_is_woocommerce_active() && bwfan_is_woocommerce_subscriptions_active() ) {
	BWFAN_Merge_Tag_Loader::register( 'wc_subscription', 'BWFAN_WCS_Shipping_Address', null, __( 'WooCommerce Subscription', 'wp-marketing-automations-pro' ) );
}
