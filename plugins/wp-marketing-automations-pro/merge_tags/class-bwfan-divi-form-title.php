...
class BWFAN_Divi_Form_Title extends BWFAN_Merge_Tag {
	...
	public function __construct() {
		$this->tag_name        = 'divi_form_title';
		$this->tag_description = __( 'Form Title', 'wp-marketing-automations-pro' );
		add_shortcode( 'bwfan_divi_form_title', array( $this, 'parse_shortcode' ) );
	}
...
if ( function_exists( 'bwfan_is_divi_forms_active' ) && bwfan_is_divi_forms_active() ) {
	BWFAN_Merge_Tag_Loader::register( 'divi_forms', 'BWFAN_Divi_Form_Title', null, __( 'Divi Forms', 'wp-marketing-automations-pro' ) );
}
