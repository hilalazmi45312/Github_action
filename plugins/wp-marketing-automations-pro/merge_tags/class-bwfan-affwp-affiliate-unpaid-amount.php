...
class BWFAN_AFFWP_Affiliate_Unpaid_Amount extends BWFAN_Merge_Tag {
	...
	public function __construct() {
		...
		$this->tag_description = __( 'Affiliate Unpaid Amount', 'wp-marketing-automations-pro' );
		add_shortcode( 'bwfan_affwp_affiliate_unpaid_amount', array( $this, 'parse_shortcode' ) );
		add_shortcode( 'bwfan_affwp_unpaid_amount', array( $this, 'parse_shortcode' ) );
...
if ( bwfan_is_affiliatewp_active() ) {
	BWFAN_Merge_Tag_Loader::register( 'aff_affiliate', 'BWFAN_AFFWP_Affiliate_Unpaid_Amount', null, __( 'AffiliateWP', 'wp-marketing-automations-pro' ) );
}
