...
if ( ! BWFAN_PRO_Common::is_lite_3_0() && ! class_exists( 'BWFAN_Contact_Timezone' ) ) {
	class BWFAN_Contact_Timezone extends BWFAN_Merge_Tag {
		...
		public function __construct() {
			...
			$this->tag_description = __( 'Contact Timezone', 'wp-marketing-automations-pro' );
	 ...
	 */
	BWFAN_Merge_Tag_Loader::register( 'bwf_contact', 'BWFAN_Contact_Timezone', null, __( 'Contact', 'wp-marketing-automations-pro' ) );
}