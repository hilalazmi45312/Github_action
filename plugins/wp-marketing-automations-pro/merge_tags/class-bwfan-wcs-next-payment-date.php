...
class BWFAN_WCS_Next_Payment_Date extends BWFAN_Merge_Tag {
	...
	public function __construct() {
		...
		$this->tag_description = __( 'Subscription Next Payment Date', 'wp-marketing-automations-pro' );
	...
	public function parse_shortcode( $attr ) {
		...
		$date = $this->format_datetime( $subscription->get_date( 'next_payment' ), $parameters );
