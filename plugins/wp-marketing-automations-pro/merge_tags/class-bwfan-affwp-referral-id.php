...
class BWFAN_AFFWP_Referral_ID extends BWFAN_Merge_Tag {
	...
	public function __construct() {
		...
		$this->tag_description = __( 'Referral ID', 'wp-marketing-automations-pro' );
	...
	public function parse_shortcode( $attr ) {
		...
		$referral_id = is_array( $referral_id ) ? implode( ',', $referral_id ) : $referral_id;
...
if ( bwfan_is_affiliatewp_active() ) {
	BWFAN_Merge_Tag_Loader::register( 'aff_referral', 'BWFAN_AFFWP_Referral_ID', null, __( 'AffiliateWP', 'wp-marketing-automations-pro' ) );
}
