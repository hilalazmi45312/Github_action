...
if ( ! BWFAN_PRO_Common::is_lite_3_0() && ! class_exists( 'BWFAN_Contact_Company' ) ) {
	class BWFAN_Contact_Company extends BWFAN_Merge_Tag {
		...
		public function __construct() {
			...
			$this->tag_description = __( 'Contact Company', 'wp-marketing-automations-pro' );
	 ...
	 */
	BWFAN_Merge_Tag_Loader::register( 'bwf_contact', 'BWFAN_Contact_Company', null, __( 'Contact', 'wp-marketing-automations-pro' ) );
}