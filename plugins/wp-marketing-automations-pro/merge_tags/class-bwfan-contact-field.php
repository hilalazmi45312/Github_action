...
if ( ! BWFAN_PRO_Common::is_lite_3_0() && ! class_exists( 'BWFAN_Contact_Field' ) ) {
	class BWFAN_Contact_Field extends BWFAN_Merge_Tag {
		...
		public function __construct() {
			...
			$this->tag_description = __( 'Contact Field', 'wp-marketing-automations-pro' );
		...
		public function data_key() {
            ...
            <div class="bwfan_mtag_wrap">
                <div class="bwfan_label">
                    <label for="" class="bwfan-label-title"><?php esc_html_e( 'Field Key', 'wp-marketing-automations-pro' ); ?></label>
                </div>
                <div class="bwfan_label_val">
                    <input type="text" class="bwfan-input-wrapper bwfan_tag_input" name="key" required/>
                    <div class="clearfix bwfan_field_desc"><?php esc_html_e( 'Input the correct field key in order to get the data', 'wp-marketing-automations-pro' ); ?></div>
                </div>
            </div>
			<?php
		}
		...
		public function get_setting_schema() {
			return [
				[
					...
					'class'       => '',
					'placeholder' => '',
					'hint'        => __( 'Input the correct field key in order to get the data', 'wp-marketing-automations-pro' ),
					'required'    => true,
					'toggler'     => array(),
				],
			];
	 ...
	 */
	BWFAN_Merge_Tag_Loader::register( 'bwf_contact', 'BWFAN_Contact_Field', null, __( 'Contact', 'wp-marketing-automations-pro' ) );
