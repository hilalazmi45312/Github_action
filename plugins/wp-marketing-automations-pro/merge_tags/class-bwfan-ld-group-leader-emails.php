...
class BWFAN_LD_Group_Leader_Emails extends BWFAN_Merge_Tag {
	...
	public function __construct() {
		...
		$this->tag_description = __( 'Group Leader(s) Emails', 'wp-marketing-automations-pro' );
	...
	public function parse_shortcode( $attr ) {
		...
		$leader_emails = $this->get_group_leaders_email( $groups );
	 ...
	 * @return array
	 */
	public function get_group_leaders_email( $group_ids ) {
...
if ( bwfan_is_learndash_active() ) {
	BWFAN_Merge_Tag_Loader::register( 'learndash_group', 'BWFAN_LD_Group_Leader_Emails', null, __( 'Learndash', 'wp-marketing-automations-pro' ) );
}
