...
class BWFAN_Optin_Form_ID extends BWFAN_Merge_Tag {

	private static $instance = null;

	public function __construct() {
		$this->tag_name        = 'optin_form_id';
		$this->tag_description = __( 'Form ID', 'wp-marketing-automations-pro' );
		add_shortcode( 'bwfan_optin_form_id', array( $this, 'parse_shortcode' ) );
	}
...
if ( function_exists( 'bwfan_is_optin_forms_active' ) && bwfan_is_optin_forms_active() ) {
	BWFAN_Merge_Tag_Loader::register( 'optinforms', 'BWFAN_Optin_Form_ID' );
}
