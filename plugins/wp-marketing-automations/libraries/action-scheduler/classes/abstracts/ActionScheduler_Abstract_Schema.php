...
abstract class ActionScheduler_Abstract_Schema {
	...
	public function tables_exist() {
		...
		foreach ( $this->tables as $table_name ) {
			...
			$existing_table = $wpdb->get_var( $wpdb->prepare( 'SHOW TABLES LIKE %s', $pattern ) ); //phpcs:ignore WordPress.DB.DirectDatabaseQuery.DirectQuery, WordPress.DB.DirectDatabaseQuery.NoCaching
