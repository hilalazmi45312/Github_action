...
class ActionScheduler_wpPostStore_PostStatusRegistrar {
	...
	protected function post_status_failed_labels() {
		$labels = array(
			'label'       => _x( 'Failed', 'post', 'woocommerce' ), // phpcs:ignore WordPress.WP.I18n.TextDomainMismatch
			/* translators: %s: count */
			'label_count' => _n_noop( 'Failed <span class="count">(%s)</span>', 'Failed <span class="count">(%s)</span>', 'woocommerce' ), // phpcs:ignore WordPress.WP.I18n.TextDomainMismatch
		);
	...
	protected function post_status_running_labels() {
		$labels = array(
			'label'       => _x( 'In-Progress', 'post', 'woocommerce' ), // phpcs:ignore WordPress.WP.I18n.TextDomainMismatch
			/* translators: %s: count */
			'label_count' => _n_noop( 'In-Progress <span class="count">(%s)</span>', 'In-Progress <span class="count">(%s)</span>', 'woocommerce' ), // phpcs:ignore WordPress.WP.I18n.TextDomainMismatch
		);
