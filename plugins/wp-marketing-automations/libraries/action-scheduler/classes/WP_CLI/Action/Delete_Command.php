	...
	public function execute() {
		...
		$progress_bar = \WP_CLI\Utils\make_progress_bar(
			sprintf(
				...
				_n( 'Deleting %d action', 'Deleting %d actions', $this->action_counts['total'], 'woocommerce' ), // phpcs:ignore WordPress.WP.I18n.TextDomainMismatch
		...
		$format = _n( 'Deleted %1$d action', 'Deleted %1$d actions', $this->action_counts['deleted'], 'woocommerce' ) . ', '; // phpcs:ignore WordPress.WP.I18n.TextDomainMismatch
		/* translators: %2$d: number of actions deletions failed */
		$format .= _n( '%2$d failure.', '%2$d failures.', $this->action_counts['failed'], 'woocommerce' ); // phpcs:ignore WordPress.WP.I18n.TextDomainMismatch
