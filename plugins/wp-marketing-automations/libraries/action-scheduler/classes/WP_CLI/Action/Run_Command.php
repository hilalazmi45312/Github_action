	...
	public function execute() {
		...
		$progress_bar = \WP_CLI\Utils\make_progress_bar(
			sprintf(
				...
				_n( 'Executing %d action', 'Executing %d actions', $this->action_counts['total'], 'woocommerce' ), // phpcs:ignore WordPress.WP.I18n.TextDomainMismatch
		...
		foreach ( array(
			 ...
			 */
			$format = _n( '%1$d action %2$s.', '%1$d actions %2$s.', $count, 'woocommerce' ); // phpcs:ignore WordPress.WP.I18n.TextDomainMismatch
		...
		\WP_CLI::success(
			sprintf(
				...
				_n( 'Executed %d action.', 'Executed %d actions.', $this->action_counts['executed'], 'woocommerce' ), // phpcs:ignore WordPress.WP.I18n.TextDomainMismatch
