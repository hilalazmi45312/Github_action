...
class ActionScheduler_InvalidActionException extends \InvalidArgumentException implements ActionScheduler_Exception {
	...
	public static function from_schedule( $action_id, $schedule ) {
		$message = sprintf(
			...
			__( 'Action [%1$s] has an invalid schedule: %2$s', 'woocommerce' ), // phpcs:ignore WordPress.WP.I18n.TextDomainMismatch
			$action_id,
	...
	public static function from_decoding_args( $action_id, $args = array() ) {
		$message = sprintf(
			...
			__( 'Action [%1$s] has invalid arguments. It cannot be JSON decoded to an array. $args = %2$s', 'woocommerce' ), // phpcs:ignore WordPress.WP.I18n.TextDomainMismatch
			$action_id,
