...
jQuery(function ($) {
	 ...
	 * @type object
	 */
	var RestrictionRuleCriteria = {
		init: function () {
			$(document).on('dey-init-scheduler-rule-restriction-rules', this.init_rules).trigger('dey-init-scheduler-rule-restriction-rules');
			// Add a rules group.
			$('.dey-scheduler-rule-options-wrapper').on('click', '.dey-add-restriction-rules-group', this.add_rule_group);
			// Remove the rules group.
			$('.dey-scheduler-rule-options-wrapper').on('click', '.dey-remove-restriction-rules-group', this.remove_rule_group);
			// Add a rule.
			$('.dey-scheduler-rule-options-wrapper').on('click', '.dey-add-restriction-rule', this.add_rule);
			// Remove the rule.
			$('.dey-scheduler-rule-options-wrapper').on('click', '.dey-remove-restriction-rule', this.remove_rule);
			// Toggle rules wrapper.
			$('.dey-scheduler-rule-options-wrapper').on('click', '.dey-restriction-rules-toggle', this.toggle_rules_wrapper);
			// Toggle the rule type.
			$('.dey-scheduler-rule-options-wrapper').on('change', '.dey-restriction-rule-type', this.toggle_rule_type);
			// Toggle the rule product type.
			$('.dey-scheduler-rule-options-wrapper').on('change', '.dey-restriction-rule-product-type', this.toggle_rule_product_type);
			// Toggle the rule order type.
			$('.dey-scheduler-rule-options-wrapper').on('change', '.dey-restriction-rule-order-type', this.toggle_rule_order_type);
		},
		 ...
		 */
		init_rules: function () {
			// Scheduler rule types.
			$('.dey-scheduler-rule-options-wrapper').find('.dey-restriction-rule-type').each(function () {
				RestrictionRuleCriteria.handle_rule_type(this);
			});
		},
		...
		toggle_rule_type: function (event) {
			event.preventDefault();
			RestrictionRuleCriteria.handle_rule_type($(event.currentTarget));
		},
		...
		toggle_rule_product_type: function (event) {
			event.preventDefault();
			RestrictionRuleCriteria.handles_rule_product_type($(event.currentTarget));
		},
		...
		toggle_rule_order_type: function (event) {
			event.preventDefault();
			RestrictionRuleCriteria.handle_rule_order_type($(event.currentTarget));
		},
		...
		handle_rule_type: function ($this) {
			...
			switch ($($this).val()) {
				case '1': // Product.
					...
					RestrictionRuleCriteria.handles_rule_product_type(wrapper.find('.dey-restriction-rule-product-type'));
					break;
				...
				case '3': // Order.
					...
					RestrictionRuleCriteria.handle_rule_order_type(wrapper.find('.dey-restriction-rule-order-type'));
					break;
			}
		},
		...
		add_rule_group: function (event) {
			...
			$(document).trigger('dey-init-scheduler-rule-restriction-rules');
