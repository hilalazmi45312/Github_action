<?php
/**
 * Customer - Today Order Delivery With Slot.
 *
 * @since 1.0.0
 * */
...
if ( ! class_exists( 'DEY_Customer_Today_Order_Delivery_With_Slot_Notification' ) ) {
	 ...
	 * @since 1.0.0
	 * */
	class DEY_Customer_Today_Order_Delivery_With_Slot_Notification extends DEY_Notifications {
		...
		public function __construct() {
			$this->id          = 'customer_today_order_delivery_with_slot';
			$this->type        = 'customer';
			$this->title       = __( 'Customer Delivery Notification - Order Delivery With Time Slots', 'delivery-slots-for-woocommerce' );
		...
		public function get_default_message() {
			...
			Your order {order_id} on {site_name} will be delivered today({delivery_date}) between {time_slot}.
		...
		public function trigger( $order_delivery ) {
			...
			$this->placeholders['{time_slot}']     = $order_delivery->get_formatted_time_slots();
		...
		public function get_settings_array() {
			...
			$section_fields[] = array(
				'type'  => 'title',
				'title' => __( 'Order Delivery With Time Slots', 'delivery-slots-for-woocommerce' ),
				'id'    => 'dey_today_order_delivery_with_slot_email_options',
			);
			$section_fields[] = array(
