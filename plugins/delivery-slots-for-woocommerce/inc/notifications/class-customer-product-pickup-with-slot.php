<?php
/**
 * Customer - Product Pickup With Slot.
 *
 * @since 3.5.0
 * */
...
if ( ! class_exists( 'DEY_Customer_Product_Pickup_With_Slot_Notification' ) ) {
	 ...
	 * @since 3.5.0
	 * */
	class DEY_Customer_Product_Pickup_With_Slot_Notification extends DEY_Notifications {
		...
		public function __construct() {
			$this->id          = 'customer_product_pickup_with_slot';
			$this->type        = 'customer';
			$this->title       = __( 'Customer Product Pickup Notification - With Time Slots', 'delivery-slots-for-woocommerce' );
		...
		public function get_default_subject() {
			return 'Pickup Reminder for your Product {product_name} on {site_name}';
		}
		...
		public function get_default_message() {
			...
			The Product {product_link} associated Order {order_id} on {site_name} should be pickup on({pickup_date}) between {time_slot}.
		...
		public function trigger( $product_pickup ) {
			...
			$this->recipient                      = $product_pickup->get_user_email();
