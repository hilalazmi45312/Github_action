<?php
/**
 * Customer - Today Product Delivery Without Slot.
 *
 * @since 1.0.0
 * */
...
if ( ! class_exists( 'DEY_Customer_Today_Product_Delivery_Without_Slot_Notification' ) ) {
	 ...
	 * @since 1.0.0
	 * */
	class DEY_Customer_Today_Product_Delivery_Without_Slot_Notification extends DEY_Notifications {
		...
		public function __construct() {
			$this->id          = 'customer_today_product_delivery_without_slot';
			$this->type        = 'customer';
			$this->title       = __( 'Customer Delivery Notification - Product Delivery Without Time Slots', 'delivery-slots-for-woocommerce' );
		...
		public function get_default_message() {
			...
			Product {product_name} associated with Order {order_id} on {site_name} will be delivered today({delivery_date}).
		...
		public function get_settings_array() {
			...
			$section_fields[] = array(
				'type'  => 'title',
				'title' => __( 'Product Delivery Without Time Slots', 'delivery-slots-for-woocommerce' ),
				'id'    => 'dey_today_product_delivery_without_slot_email_options',
			);
			$section_fields[] = array(
