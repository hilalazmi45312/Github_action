<?php
/**
 * Customer - Product Pickup Without Slot.
 *
 * @since 3.5.0
 * */
...
if ( ! class_exists( 'DEY_Customer_Product_Pickup_Without_Slot_Notification' ) ) {
	 ...
	 * @since 3.5.0
	 * */
	class DEY_Customer_Product_Pickup_Without_Slot_Notification extends DEY_Notifications {
		...
		public function __construct() {
			$this->id          = 'customer_product_pickup_without_slot';
			$this->type        = 'customer';
			$this->title       = __( 'Customer Product Pickup Notification - Without Time Slots', 'delivery-slots-for-woocommerce' );
		...
		public function get_default_message() {
			...
			The Product {product_link} associated Order {order_id} on {site_name} should be pickup on({pickup_date})
