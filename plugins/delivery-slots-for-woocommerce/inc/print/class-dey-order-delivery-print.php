...
/**
 * Handles the order delivery print.
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit ; // Exit if accessed directly.
}

if ( ! class_exists( 'DEY_Order_Delivery_Print' ) ) {

	/**
	 * Class.
	 */
	class DEY_Order_Delivery_Print {
		...
		public function get_default_column_names() {
			 ...
			 * @since 1.0
			 */
			return apply_filters( 'dey_order_delivery_print_heading', $headings ) ;
		}
		...
		public function get_data_to_print() {
			...
			foreach ( $order_delivery_ids as $order_delivery_id ) {
				...
				$row_data[] = self::generate_row_data( $order_delivery ) ;
			}
		...
		protected function generate_row_data( $order_delivery ) {
			 ...
			 * @since 1.0
			 */
			return apply_filters( 'dey_order_delivery_print_row_data', $row ) ;
		}
