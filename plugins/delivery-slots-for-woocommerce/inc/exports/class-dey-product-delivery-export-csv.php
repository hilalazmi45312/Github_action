...
/**
 * Handles the product delivery exports.
 */
if ( ! defined( 'ABSPATH' ) ) {
...
if ( ! class_exists( 'DEY_Product_Delivery_Export_CSV' ) ) {

	/**
	 * DEY_Product_Delivery_Export_CSV.
	 */
	class DEY_Product_Delivery_Export_CSV extends WC_CSV_Exporter {
		 ...
		 * @var string
		 */
		protected $export_type = 'product_delivery' ;
		 ...
		 * @var string
		 */
		protected $filename = 'product-delivery.csv' ;
		...
		public function prepare_data_to_export() {
			...
			foreach ( $product_delivery_ids as $product_delivery_id ) {
				...
				$this->row_data[] = self::generate_row_data( $product_delivery ) ;
			}
		}
