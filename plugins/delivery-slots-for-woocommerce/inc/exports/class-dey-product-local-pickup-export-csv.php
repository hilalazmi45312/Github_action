<?php
/**
 * Handles the product pickup exports.
 *
 * @since 3.5.0
 */
...
if ( ! class_exists( 'DEY_Product_Local_Pickup_Export_CSV' ) ) {
	 ...
	 * @since 3.5.0
	 */
	class DEY_Product_Local_Pickup_Export_CSV extends WC_CSV_Exporter {
		 ...
		 * @var string
		 */
		protected $export_type = 'product_pickup';
		 ...
		 * @var string
		 */
		protected $filename = 'product-pickup.csv';
		...
		public function get_default_column_names() {
			...
			/**
			 * This hook is used to alter the product pickup heading.
			 *
			 * @since 3.5.0
			 */
			return apply_filters( 'dey_product_pickup_export_heading', $headings );
		}
		...
		public function prepare_data_to_export() {
			...
			foreach ( $this->get_product_pickup_ids() as $product_pickup_id ) {
				...
				$this->row_data[] = self::generate_row_data( $product_pickup );
			}
		}
		 ...
		 *
		 * @since 3.5.0
		 * @param object $product_pickup Product pickup.
		 * @return array
		 */
		protected function generate_row_data( $product_pickup ) {
			 ...
			 * @since 3.5.0
			 */
			return apply_filters( 'dey_product_pickup_export_row_data', $row );
		}
