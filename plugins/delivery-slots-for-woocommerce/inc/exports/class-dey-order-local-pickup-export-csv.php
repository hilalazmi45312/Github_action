...
/**
 * Handles the order local pickup exports.
 */
if ( ! defined( 'ABSPATH' ) ) {
...
if ( ! class_exists( 'DEY_Order_Local_Pickup_Export_CSV' ) ) {

	/**
	 * Class.
	 */
	class DEY_Order_Local_Pickup_Export_CSV extends WC_CSV_Exporter {
		 ...
		 * @var string
		 */
		protected $export_type = 'order_local_pickup' ;
		 ...
		 * @var string
		 */
		protected $filename = 'order-local-pickup.csv' ;
		...
		public function get_default_column_names() {
			 ...
			 * @since 1.0
			 */
			return apply_filters( 'dey_order_local_pickup_export_heading', $headings ) ;
		}
		...
		public function prepare_data_to_export() {
			...
			foreach ( $order_local_pickup_ids as $order_local_pickup_id ) {
				...
				$this->row_data[] = self::generate_row_data( $order_local_pickup ) ;
			}
		}
		...
		protected function generate_row_data( $order_local_pickup ) {
			 ...
			 * @since 1.0
			 */
			return apply_filters( 'dey_order_local_pickup_export_row_data', $row ) ;
		}
