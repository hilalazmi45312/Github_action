<?php
/**
 * Scheduler rule popup - Special day.
 *
 * @since 4.0.0
 */
...
?>
<div class='dey-hide dey-special-day-modal-wrapper' id='dey_scheduler_rule_special_day_modal'>
	...
	<div class='dey-special-day-modal-content'>
		...
		woocommerce_wp_select(
			array(
				'id'      => 'dey_special_days[schedule_type]',
	...
	<div class='dey-special-day-modal-footer'>
		<input type='button' class='button-primary dey-create-scheduler-rule-special-day' value="<?php esc_html_e( 'Create', 'delivery-slots-for-woocommerce' ); ?>">
	</div>
</div>
<?php
