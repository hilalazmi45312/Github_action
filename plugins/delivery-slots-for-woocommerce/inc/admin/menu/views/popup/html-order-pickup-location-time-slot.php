<?php
/**
 * Popup - Order pickup location time slot.
 *
 * @since 4.0.0
 */
...
?>
<div class='dey-hide dey-order-time-slot-modal-wrapper' id='dey_order_pickup_location_time_slot_modal'>
	...
	<div class='dey-order-time-slot-modal-footer'>
		<input type='button' class='button-primary dey-create-order-pickup-location-time-slot' value="<?php esc_html_e( 'Create', 'delivery-slots-for-woocommerce' ); ?>">
	</div>
</div>
<?php
