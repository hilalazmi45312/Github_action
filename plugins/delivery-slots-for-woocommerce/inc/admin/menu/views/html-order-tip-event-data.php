<?php
/**
 * Order tip event data.
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit ; // Exit if accessed directly.
}
$event_data = dey_get_order_tip_event_data( $order_tip ) ;
?>
<div class="dey-calender-event-popup">
	<div class="dey-calender-event-title">
		<?php echo esc_html( '#' . $order_tip->get_order_id() ) ; ?>
		<span><?php echo wp_kses_post( dey_display_post_status( $order_tip->get_status() ) ) ; ?></span>
	</div>
