<?php
/**
 * Pickup location panel - local pickup.
 *
 * @since 4.0.0
 */
...
?>
<div id='dey_order_pickup_scheduler_data_local_pickup' class='dey-order-pickup-scheduler-options-wrapper woocommerce_options_panel'>
	<div class='options_group'>
		...
		woocommerce_wp_text_input(
			array(
				...
				'type'              => 'number',
				'default'           => '7',
				'value'             => $dey_pickup_location->get_pickup_days_availability(),
				'desc_tip'          => true,
		...
		woocommerce_wp_select(
			array(
				...
				'class'             => 'dey_select2',
				'value'             => $dey_pickup_location->get_pickup_days(),
		...
		woocommerce_wp_text_input(
			array(
				...
				'type'              => 'number',
				'default'           => '10',
				'value'             => $dey_pickup_location->get_pickup_max_per_day(),
				'desc_tip'          => true,
		...
		woocommerce_wp_checkbox(
			array(
				...
				'default'     => 'no',
				'value'       => $dey_pickup_location->get_pickup_location_required(),
		...
		woocommerce_wp_checkbox(
			array(
				...
				'type'        => 'checkbox',
				'default'     => 'no',
				'value'       => $dey_pickup_location->get_pickup_calender_required(),
	...
	<div class='options_group'>
		...
		woocommerce_wp_select(
			array(
				...
				'value'       => $dey_pickup_location->get_pickup_time_mode(),
				'desc_tip'    => true,
		...
		<p class='form-field dey-order-delivery-slots-field'>
			<label for='dey_order_pickup_available_time_from'><?php esc_html_e( 'Time Selector', 'delivery-slots-for-woocommerce' ); ?> <span class='required'>*</span></label>
			<?php
			dey_get_datepicker_html(
				array(
					...
					'value'       => $dey_pickup_location->get_pickup_available_time_from(),
				)
			);
			...
			dey_get_datepicker_html(
				array(
					...
					'placeholder' => DEY_Date_Time::get_wp_time_format(),
					'class'       => 'dey-order-local-pickup-time-field',
					'value'       => $dey_pickup_location->get_pickup_available_time_to(),
				)
			);
	...
	<div class='options_group'>
		...
		<p class='form-field dey-delivery-slots-field'>
			...
			<?php
			$option_value = $dey_pickup_location->get_pickup_processing_time();
		...
		<p class='form-field'>
			...
			dey_get_datepicker_html(
				array(
					...
					'time_only'   => true,
					'placeholder' => DEY_Date_Time::get_wp_time_format(),
					'value'       => $dey_pickup_location->get_pickup_same_day_cutoff_time(),
					'desc_tip'    => true,
		...
		<p class='form-field'>
			...
			dey_get_datepicker_html(
				array(
					...
					'time_only'   => true,
					'placeholder' => DEY_Date_Time::get_wp_time_format(),
					'value'       => $dey_pickup_location->get_pickup_next_day_cutoff_time(),
					'desc_tip'    => true,
					'description' => __( 'Order processing time will start from the next day if the order is placed after the cut off time.', 'delivery-slots-for-woocommerce' ),
				)
			);
	...
	<div class='options_group'>
		...
		<div class='dey-pickup-location-order-local-pickup-weekdays-prices-options'>
			<p class='form-field'>
				<?php
			...
			<p class='form-field'>
				<?php
				$option_value = $dey_pickup_location->get_pickup_weekdays_prices();
		...
		woocommerce_wp_text_input(
			array(
				...
				'type'              => 'number',
				'default'           => '',
				'value'             => $dey_pickup_location->get_pickup_same_day_fee(),
				'custom_attributes' => array(
					'min'  => 1,
					'step' => 'any',
				),
		...
		woocommerce_wp_text_input(
			array(
				...
				'type'              => 'number',
				'default'           => '',
				'value'             => $dey_pickup_location->get_pickup_next_day_fee(),
				'custom_attributes' => array(
					'min'  => 1,
					'step' => 'any',
				),
	...
	<div class='options_group'>
		...
		woocommerce_wp_checkbox(
			array(
				...
				'type'        => 'checkbox',
				'default'     => 'no',
				'value'       => $dey_pickup_location->get_pickup_calculate_tax(),
