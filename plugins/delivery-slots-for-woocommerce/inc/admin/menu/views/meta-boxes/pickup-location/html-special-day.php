...
$name = 'dey_order_pickup_special_days[' . $key . ']';
?>
	...
	<div class='dey-scheduler-rule-special-day-content dey-order-delivery-slots-content-wrapper dey-hide'>
		...
		<p class='form-field dey-delivery-slots-field'>
			...
			<?php if ( ! empty( $special_day['order_count'] ) ) : ?>
				...
				<input type='button' class='button dey-reset-pickup-location-special-day-usage-count' data-key="<?php echo esc_attr( $key ); ?>" value="<?php esc_attr_e( 'Reset', 'delivery-slots-for-woocommerce' ); ?>"/>
			<?php endif; ?>
