<?php
/**
 * Pickup location - Status meta box.
 */

defined( 'ABSPATH' ) || exit;
?>
<div class='submitbox dey-pickup-location-status' id='submitpost'>
	<div id='minor-publishing'>
		<div id='misc-publishing-actions'>
			<?php if ( '0000-00-00 00:00:00' !== $dey_pickup_location->get_created_date() ) : ?>
				<div class='dey-status-field-row dey-created-row'>
					...
					<span class='dey-status-content'><?php echo esc_html( $dey_pickup_location->get_formatted_created_date() ); ?></span>
				</div>
			<?php endif; ?>
			<?php if ( '0000-00-00 00:00:00' !== $dey_pickup_location->get_modified_date() ) : ?>
				<div class='dey-status-field-row dey-modified-row'>
					...
					<span class='dey-status-content'><?php echo esc_html( $dey_pickup_location->get_formatted_modified_date() ); ?></span>
				</div>
			<?php endif; ?>
			<div class='dey-status-field-row dey-status-row'>
				...
				<span class='dey-status-content'>
					<select name='post_status' id='post_status'>
						<option value='dey_active' <?php selected( $dey_pickup_location->get_status(), 'dey_active' ); ?>><?php esc_html_e( 'Active', 'delivery-slots-for-woocommerce' ); ?></option>
						<option value='dey_inactive' <?php selected( $dey_pickup_location->get_status(), 'dey_inactive' ); ?>><?php esc_html_e( 'In-Active', 'delivery-slots-for-woocommerce' ); ?></option>
					</select>
				</span>
			</div>
		</div>
