...
?>
<div id='dey_scheduler_rule_data_criteria' class='dey-scheduler-rule-options-wrapper woocommerce_options_panel'>
	<div class='dey-restriction-rules-group-wrapper dey-rules-group-wrapper'>
		...
		<div class='dey-restriction-rules-group-content dey-rules-group-content'>
			<?php
			$rule_groups = $dey_scheduler_rule->get_restriction_rule_groups();
	...
	<script type='text/html' id='tmpl-dey-restriction-rule'>
		<?php require DEY_ABSPATH . 'inc/admin/menu/views/meta-boxes/scheduler-rule/html-restriction-rule.php'; ?>
	</script>
