<?php
/**
 * This template displays the order tip in the checkout block.
 *
 * This template can be overridden by copying it to yourtheme/delivery-slots-for-woocommerce/blocks/checkout-order-tip.php
 *
 ...
 * @since 3.7.0
 */
do_action('dey_before_block_checkout_order_tip_wrapper');
?>
 ...
 * @since 3.7.0
 */
do_action('dey_after_block_checkout_order_tip_wrapper');
