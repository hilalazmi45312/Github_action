<?php
/**
 * This template displays the cart order tip.
 *
 * This template can be overridden by copying it to yourtheme/delivery-slots-for-woocommerce/cart-order-tip.php
 *
 ...
 * @since 1.0.0
 */
do_action( 'dey_before_cart_order_tip_wrapper' );
?>
 ...
 * @since 1.0
 */
do_action( 'dey_after_cart_order_tip_wrapper' );
