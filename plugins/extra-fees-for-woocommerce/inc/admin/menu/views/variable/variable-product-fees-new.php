...
<div class="efw-rules-content-wrapper">
	...
	<div class="efw-rule-fields efw-fee-wrapper">
		...
		<p class="form-field efw-rule-fixed-fee">
			...
			<input type="number" min="0" name="efw_product_fees[<?php echo esc_attr( $loop ) ; ?>][new][<?php echo esc_attr( $key ) ; ?>][efw_fixed_fee]" value=""/>
		</p>
		<p class="form-field efw-rule-percent-fee">
			...
			<input type="number" min="0" name="efw_product_fees[<?php echo esc_attr( $loop ) ; ?>][new][<?php echo esc_attr( $key ) ; ?>][efw_percent_fee]" value=""/>
		</p>
		<p class="form-field">
