...
class Section_CSS extends \WooCommerce_Product_Search_Admin_Base {
	...
	public static function save() {
		...
		$settings->set( \WooCommerce_Product_Search::INLINE_CSS, isset( $_POST[\WooCommerce_Product_Search::INLINE_CSS] ) ? trim( strip_tags( $_POST[\WooCommerce_Product_Search::INLINE_CSS] ) ) : \WooCommerce_Product_Search::INLINE_CSS_DEFAULT ); // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized
		$settings->save();
	}
