...
class Section_Cache_Memcached extends \WooCommerce_Product_Search_Admin_Base {
	...
	public static function render() {
		...
		echo '</div>';
		echo '<div class="cache-settings-field-input">';
		printf( '<input id="%s" name="%s" type="text" value="%s" placeholder="%s" />', 'host', 'host', esc_attr( $host ), esc_attr( Memcached_Cache::HOST_DEFAULT ) );
		echo ' ';
		printf( '<label for="%s">', 'host' );
		...
		echo '</div>';
		echo '<div class="cache-settings-field-input">';
		printf( '<input id="%s" name="%s" type="text" value="%s" placeholder="%s"/>', 'port', 'port', esc_attr( $port ), esc_attr( Memcached_Cache::PORT_DEFAULT ) );
		echo ' ';
		printf( '<label for="%s">', 'port' );
