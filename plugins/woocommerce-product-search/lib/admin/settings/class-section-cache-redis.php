...
class Section_Cache_Redis extends \WooCommerce_Product_Search_Admin_Base {
	...
	public static function save() {
		...
		$host = !empty( $_POST['host'] ) ? $_POST['host'] : ''; // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized
		...
		$port = !empty( $_POST['port'] ) ? $_POST['port'] : ''; // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized
		...
		$username = !empty( $_POST['username'] ) ? $_POST['username'] : ''; // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized
		...
		$password = !empty( $_POST['password'] ) ? $_POST['password'] : ''; // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized
	...
	public static function render() {
		...
		echo '</div>';
		echo '<div class="cache-settings-field-input">';
		printf( '<input id="%s" name="%s" type="text" value="%s" placeholder="%s" />', 'host', 'host', esc_attr( $host ), esc_attr( Redis_Cache_Base::HOST_DEFAULT ) );
		echo ' ';
		printf( '<label for="%s">', 'host' );
		echo 'Host or socket.';
		echo ' ';
		...
		echo '</div>';
		echo '<div class="cache-settings-field-input">';
		printf( '<input id="%s" name="%s" type="number" value="%s" placeholder="%s"/>', 'port', 'port', esc_attr( $port ), esc_attr( Redis_Cache_Base::PORT_DEFAULT ) );
		echo ' ';
		printf( '<label for="%s">', 'port' );
