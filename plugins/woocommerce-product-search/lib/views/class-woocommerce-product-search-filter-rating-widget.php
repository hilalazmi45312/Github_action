...
class WooCommerce_Product_Search_Filter_Rating_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			self::$cache_id,
			__( 'Product Filter &ndash; Rating', 'woocommerce-product-search' ),
			array(
	...
	public function update( $new_instance, $old_instance ) {
		...
		$settings['has_rating_only'] = woocommerce_product_search_input_yn( $new_instance['has_rating_only'] );
	...
	public function form( $instance ) {
		...
		printf(
			'<input type="checkbox" id="%s" name="%s" %s />',
			esc_attr( $this->get_field_id( 'has_rating_only' ) ),
			esc_attr( $this->get_field_name( 'has_rating_only' ) ),
