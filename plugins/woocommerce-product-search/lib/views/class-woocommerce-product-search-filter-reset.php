...
class WooCommerce_Product_Search_Filter_Reset extends Filter_Renderer {
	...
	public static function render( $atts = array(), &$results = null) {
		...
		$output .= sprintf(
			'<button class="button wp-element-button product-search-filter-reset-clear" type="submit">%s</button>',
	...
	public static function get_reset_url( $current_url = null ) {
		...
		$keys = array(
			'ixwpss', 'wps-title', 'wps-excerpt', 'wps-content', 'wps-categories', 'wps-attributes', 'wps-tags', 'wps-sku', 'paged',
