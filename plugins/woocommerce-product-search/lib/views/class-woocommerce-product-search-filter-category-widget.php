...
class WooCommerce_Product_Search_Filter_Category_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			self::$cache_id,
			__( 'Product Filter &ndash; Categories', 'woocommerce-product-search' ),
			array(
	...
	public function form( $instance ) {
		...
		printf(
			'<input type="checkbox" id="%s" name="%s" %s />',
			esc_attr( $this->get_field_id( 'show_parent_thumbnails' ) ),
			esc_attr( $this->get_field_name( 'show_parent_thumbnails' ) ),
		...
		printf(
			'<input type="checkbox" id="%s" name="%s" %s />',
			esc_attr( $this->get_field_id( 'show_names' ) ),
			esc_attr( $this->get_field_name( 'show_names' ) ),
		...
		printf(
			'<input type="checkbox" id="%s" name="%s" %s />',
			esc_attr( $this->get_field_id( 'show_parent_names' ) ),
			esc_attr( $this->get_field_name( 'show_parent_names' ) ),
		...
		printf(
			...
			intval( $wps_show_thumbnails_count ),
			esc_attr( $this->get_field_id( 'show_selected_thumbnails' ) ),
			esc_attr( $this->get_field_name( 'show_selected_thumbnails' ) ),
		...
		printf(
			...
			esc_attr( $size ),
			esc_attr( __( 'One entry', 'woocommerce-product-search' ) )
		);
		echo '</label>';
		echo '</p>';
		echo '</div>';
		...
		printf(
			...
			esc_attr( $height ),
			esc_attr__( 'Shown when active', 'woocommerce-product-search' )
		);
		echo '</label>';
		echo '</p>';
		echo '</div>';
		...
		printf(
			...
			esc_attr( $number ),
			esc_attr__( 'Unlimited', 'woocommerce-product-search' )
		);
		echo '</label>';
		echo '</p>';
		...
		printf(
			'<input type="checkbox" id="%s" name="%s" %s />',
			esc_attr( $this->get_field_id( 'toggle' ) ),
			esc_attr( $this->get_field_name( 'toggle' ) ),
		...
		printf(
			'<input type="checkbox" id="%s" name="%s" %s />',
			esc_attr( $this->get_field_id( 'toggle_widget' ) ),
			esc_attr( $this->get_field_name( 'toggle_widget' ) ),
		...
		printf(
			'<input type="checkbox" id="%s" name="%s" %s />',
			esc_attr( $this->get_field_id( 'auto_expand' ) ),
			esc_attr( $this->get_field_name( 'auto_expand' ) ),
		...
		printf(
			'<input type="checkbox" id="%s" name="%s" %s />',
			esc_attr( $this->get_field_id( 'auto_retract' ) ),
			esc_attr( $this->get_field_name( 'auto_retract' ) ),
		...
		printf(
			'<input type="checkbox" id="%s" name="%s" %s />',
			esc_attr( $this->get_field_id( 'expander' ) ),
			esc_attr( $this->get_field_name( 'expander' ) ),
		...
		printf(
			'<input type="checkbox" id="%s" name="%s" %s />',
			esc_attr( $this->get_field_id( 'show_ancestors' ) ),
			esc_attr( $this->get_field_name( 'show_ancestors' ) ),
		...
		printf(
			'<input type="checkbox" id="%s" name="%s" %s />',
			esc_attr( $this->get_field_id( 'show_parent_navigation' ) ),
			esc_attr( $this->get_field_name( 'show_parent_navigation' ) ),
		...
		echo '<h4>';
		esc_html_e( 'Terms', 'woocommerce-product-search' );
		echo '</h4>';
		...
		printf(
			'<input type="checkbox" id="%s" name="%s" %s />',
			esc_attr( $this->get_field_id( 'hierarchical' ) ),
			esc_attr( $this->get_field_name( 'hierarchical' ) ),
