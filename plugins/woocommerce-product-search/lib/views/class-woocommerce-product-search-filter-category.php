			...
			switch ( $params['style'] ) {
				...
				case 'dropdown' :
					$clear_output .= sprintf(
						'<div data-term="" class="cat-item-all nav-back product-search-%s-filter-item"><a href="%s" aria-label="%s">%s</a></div>',
						esc_attr( $taxonomy ),
						esc_url( $current_url ),
				...
				default :
					$clear_output .= sprintf(
						'<li data-term="" class="cat-item-all nav-back product-search-%s-filter-item"><a href="%s" aria-label="%s">%s</a></li>',
						esc_attr( $taxonomy ),
						esc_url( $current_url ),
						esc_attr__( 'Clear', 'woocommerce-product-search' ),
						esc_html__( 'Clear', 'woocommerce-product-search' )
