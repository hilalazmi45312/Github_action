<?php
/**
 * class-product-filter-sale-block.php
 *
...
class Product_Filter_Sale_Block extends Block {
	...
	public static function render( $atts, $content = '' ) {
		return woocommerce_product_search_filter_sale( $atts ); // nosemgrep audit.php.wp.security.xss.shortcode-attr
	}
}

Product_Filter_Sale_Block::init();
