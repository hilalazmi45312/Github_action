...
var PPCustomSubPostPrivacyInfo = function PPCustomSubPostPrivacyInfo(_ref) {
  ...
  React.createElement("div", {className: "editor-post-panel__row-label", style: {padding: "0 0 10px 0"}}, window.PPCustomPrivacySub.caption), React.createElement(SelectControl, {
    label: "",
