            ...
            function _render()
                {
                    ...
                    <div id="wph">
                        <div id="wph-header">
                            <h1><img src="<?php echo WPH_URL ?>/assets/images/wph-dashboard-icon.png" /> WP Hide & Security Enhancer <span class="plugin-mark">PRO</span> - <?php _e( "Security Scan", 'wp-hide-security-enhancer' ) ?></h1>
                        </div>
