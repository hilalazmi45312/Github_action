            ...
            function _init_new_content_path ( $saved_field_data )
                {
                    ...
                    $new_content_path   =   $this->wph->functions->prepare_path (    home_url()  . '/' .  $saved_field_data    );
                    $this->wph->functions->add_replacement( $this->wph->functions->prepare_path ( content_url() ), $new_content_path );
            ...
            function _callback_saved_new_content_path($saved_field_data)
                {
                    ...
                    $rewrite_to     =   $this->wph->functions->get_rewrite_path( $this->wph->default_variables['network']['content_path'], [ 'left_slash'  =>  TRUE, 'right_slash' =>  TRUE, 'exclude_wp_dir'    =>  TRUE  ] );
            ...
            function _callback_saved_block_wp_content_path($saved_field_data)
                {
                    ...
                    $base_slug  =   $this->wph->functions->get_relative_path_to_wp ( $this->wph->default_variables['network']['content_path'] );
                    
                    $rewrite_base   =   $this->wph->functions->get_rewrite_path( $base_slug, [ 'left_slash'  =>  FALSE, 'right_slash' =>  TRUE, 'exclude_wp_dir'    =>  TRUE ] );
                    ...
                    if($this->wph->server_nginx_config   === TRUE)           
                        {
                            ...
                            $rewrite_base   =   $this->wph->functions->get_rewrite_path( $this->wph->default_variables['network']['content_path'], [ 'left_slash'  =>  TRUE, 'right_slash' =>  TRUE, 'exclude_wp_dir'    =>  TRUE, 'type' =>  'nginx' ]  );
