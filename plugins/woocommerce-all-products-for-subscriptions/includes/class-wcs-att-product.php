...
class WCS_ATT_Product {
	...
	private static function add_hooks() {
		 ...
		 * @since 6.0.3
		 *
		 * @param boolean True, if runtime meta should be retrieved from the product object.
		 */
		if ( apply_filters( 'wcsatt_use_runtime_meta_from_product', true ) ) {
	...
	*/
	...
	public static function set_runtime_meta( $product, $key, $value ) {
		...
		if ( in_array( $key, self::$subscription_product_type_meta_keys ) ) {
			 ...
			 * @since 6.0.3
			 *
			 * @param boolean True, if runtime meta should be saved on the product object.
			 */
		} elseif ( apply_filters( 'wcsatt_use_runtime_meta_from_product', true ) ) {
